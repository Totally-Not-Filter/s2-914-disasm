...
Miles_Control:                                                 ; Offset_0x016796
                ...
                bsr.w   Miles_CPU_Control                      ; Offset_0x01688A
Offset_0x0167A0:
...
Offset_0x0167C8:
                ...
                bsr.w   Miles_RecordMoves                      ; Offset_0x016C7C
                bsr.w   Miles_Water                            ; Offset_0x016C96
...
Offset_0x0167F0:
                bsr.w   Miles_Animate                          ; Offset_0x017922
...
Miles_CPU_Normal:                                              ; Offset_0x016A68 
                bsr.w   Offset_0x016BC0
                tst.w   ($FFFFF702).w
                bne.w   Offset_0x016B82
                tst.b   Obj_Timer(A0)                                    ; $002A
                bmi.w   Offset_0x016B82
...
Miles_MdNormal:                                                ; Offset_0x016D4E  
                bsr.w   Miles_Spindash                         ; Offset_0x0173D8
                bsr.w   Miles_Jump                             ; Offset_0x0172E8
                bsr.w   Miles_SlopeResist                      ; Offset_0x0174DC
                bsr.w   Miles_Move                             ; Offset_0x016DF0
                bsr.w   Miles_Roll                             ; Offset_0x017282
                bsr.w   Miles_LevelBoundaries                  ; Offset_0x017224
                jsr     (SpeedToPos)                           ; Offset_0x011F96
                bsr.w   Player_AnglePos                        ; Offset_0x019004
                bsr.w   Miles_SlopeRepel                       ; Offset_0x01754E
                rts         
;-------------------------------------------------------------------------------
Miles_MdJump:                                                  ; Offset_0x016D76
                bsr.w   Miles_JumpHeight                       ; Offset_0x017396
                bsr.w   Miles_ChgJumpDir                       ; Offset_0x0171AA
                bsr.w   Miles_LevelBoundaries                  ; Offset_0x017224
...
Offset_0x016D96:
                bsr.w   Miles_JumpAngle                        ; Offset_0x017590
                bsr.w   Miles_Floor                            ; Offset_0x0175F0
                rts       
;-------------------------------------------------------------------------------
Miles_MdRoll:                                                  ; Offset_0x016DA0
                ...
                bsr.w   Miles_Jump                             ; Offset_0x0172E8
Offset_0x016DAA:
                bsr.w   Miles_RollRepel                        ; Offset_0x017512
                bsr.w   Miles_RollSpeed                        ; Offset_0x017098
                bsr.w   Miles_LevelBoundaries                  ; Offset_0x017224
                jsr     (SpeedToPos)                           ; Offset_0x011F96
                bsr.w   Player_AnglePos                        ; Offset_0x019004
                bsr.w   Miles_SlopeRepel                       ; Offset_0x01754E
...
Miles_Move:                                                    ; Offset_0x016DF0
                ...
                bmi.w   Offset_0x016F02
                tst.w   Obj_Player_Control(A0)                           ; $002E
                bne.w   Offset_0x016ED6
                btst    #$02, ($FFFFF606).w
                beq.s   Offset_0x016E18
                bsr.w   Offset_0x016F92
Offset_0x016E18:
                btst    #$03, ($FFFFF606).w
                beq.s   Offset_0x016E24
                bsr.w   Offset_0x017018
Offset_0x016E24:
...
Offset_0x016E86:
                jsr     (Player_HitFloor).l                      ; Offset_0x019AD0
                cmpi.w  #$000C, D1
...
Miles_RollSpeed:                                               ; Offset_0x017098
                ...
                asr.w   #$02, D4
                tst.b   Obj_Player_Status(A0)                            ; $002B
                bmi.w   Offset_0x01712E
                tst.w   Obj_Player_Control(A0)                           ; $002E
                bne.s   Offset_0x0170D0
                btst    #$02, ($FFFFF606).w
                beq.s   Offset_0x0170C4
                bsr.w   Offset_0x017164
Offset_0x0170C4:
                btst    #$03, ($FFFFF606).w
                beq.s   Offset_0x0170D0
                bsr.w   Offset_0x017188
Offset_0x0170D0:
                move.w  Obj_Inertia(A0), D0                              ; $0014
...
Offset_0x017256:
                ...
                rts
Offset_0x017266:
                bra.w   Kill_Miles                             ; Offset_0x017E78
Offset_0x01726A:
                move.w  D0, Obj_X(A0)                                    ; $0008
...
Miles_Jump:                                                    ; Offset_0x0172E8
                ...
                andi.b  #$70, D0
                beq.w   Offset_0x01738C
                moveq   #$00, D0
                move.b  Obj_Angle(A0), D0                                ; $0026
                addi.b  #$80, D0
                bsr.w   CalcRoomOverHead                       ; Offset_0x0199CE
                cmpi.w  #$0006, D1
                blt.w   Offset_0x01738C
                move.w  #$0680, D2
                btst    #$06, Obj_Status(A0)                             ; $0022
...
Offset_0x017608:
                ...
                andi.b  #$C0, D0
                cmpi.b  #$40, D0
                beq.w   Offset_0x0176D2
                cmpi.b  #$80, D0
                beq.w   Offset_0x01772E
                cmpi.b  #$C0, D0
                beq.w   Offset_0x01778A
...
Offset_0x017676:
                ...
                bsr.w   Miles_ResetMilesOnFloor                ; Offset_0x0177E6
                move.b  D3, D0
                addi.b  #$20, D0
                andi.b  #$40, D0
...
Offset_0x017870:
                bsr.w   Miles_HurtStop                         ; Offset_0x01788A
                bsr.w   Miles_LevelBoundaries                  ; Offset_0x017224
                bsr.w   Miles_RecordMoves                      ; Offset_0x016C7C
                bsr.w   Miles_Animate                          ; Offset_0x017922
                bsr.w   Load_Miles_Dynamic_PLC                 ; Offset_0x017D0A
...
Miles_HurtStop:                                                ; Offset_0x01788A
                ...
                addi.w  #$00E0, D0
                cmp.w   Obj_Y(A0), D0                                    ; $000C
                blt.w   Kill_Miles                             ; Offset_0x017E78
                bsr.w   Miles_Floor                            ; Offset_0x0175F0
                btst    #$01, Obj_Status(A0)                             ; $0022
...
Miles_Death:                                                   ; Offset_0x0178CE
                bsr.w   Miles_GameOver                         ; Offset_0x0178EA
                jsr     (ObjectFall)                           ; Offset_0x011F6A
                bsr.w   Miles_RecordMoves                      ; Offset_0x016C7C
                bsr.w   Miles_Animate                          ; Offset_0x017922
                bsr.w   Load_Miles_Dynamic_PLC                 ; Offset_0x017D0A
...
Miles_GameOver:                                                ; Offset_0x0178EA
                ...
                addi.w  #$0100, D0
                cmp.w   Obj_Y(A0), D0                                    ; $000C
                bge.w   Offset_0x01790C
                bsr.w   Offset_0x016B8E
                move.b  #$02, Obj_Routine(A0)                            ; $0024
                nop
Offset_0x01790C:
                rts  
...
Offset_0x0179BA:
                ...
                bpl.s   Offset_0x017988
                addq.b  #$01, D0
                bne.w   Offset_0x017ACC
                moveq   #$00, D0
                move.b  Obj_Flip_Angle(A0), D0                           ; $0027
                bne.w   Offset_0x017A66
                moveq   #$00, D1
                move.b  Obj_Angle(A0), D0                                ; $0026
...
Offset_0x017A14:
                tst.b   Obj_Player_Status(A0)                            ; $002B
                bpl.w   Offset_0x017A1E
                add.w   D2, D2
Offset_0x017A1E:
                move.b  D0, D3
                add.b   D3, D3
                add.b   D3, D3
                lea     (Offset_0x017BD8).l, A1
                cmpi.w  #$0600, D2
                bcs.s   Offset_0x017A4C
                lea     (Offset_0x017BE2).l, A1
                move.b  D0, D1
                lsr.b   #$01, D1
                add.b   D1, D0
                add.b   D0, D0
...
Offset_0x017ACC:
                ...
                neg.w   D2
Offset_0x017AD8:
                lea     (Offset_0x017BF1).l, A1
                cmpi.w  #$0600, D2
                bcc.s   Offset_0x017AEA
                lea     (Offset_0x017BEC).l, A1
Offset_0x017AEA:
                neg.w   D2
                addi.w  #$0400, D2
