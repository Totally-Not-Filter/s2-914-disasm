...
;-------------------------------------------------------------------------------                
Offset_0x017EF8:
                lea     (Bubbles_Animate_Data).l, A1             ; Offset_0x01839A
...
Offset_0x017FB2:
                lea     (Bubbles_Animate_Data).l, A1             ; Offset_0x01839A
                jsr     (AnimateSprite).l                        ; Offset_0x01212E
                bsr.w   Load_Oxygen_Numbers_Dynamic_PLC        ; Offset_0x018120
                tst.b   Obj_Flags(A0)                                    ; $0001
...
Offset_0x018166:
                ...
                bne.w   Offset_0x01825C
                cmpi.b  #$06, Obj_Routine(A2)                            ; $0024
                bcc.w   Offset_0x018368
                btst    #$06, Obj_Status(A2)                             ; $0022
                beq.w   Offset_0x018368
                subq.w  #$01, Obj_Control_Var_0C(A0)                     ; $0038
                bpl.w   Offset_0x018280
...
Offset_0x0181F0:
                ...
                move.l  A0, -(A7)
                move.l  A2, A0
                bsr.w   Sonic_ResetOnFloor                     ; Offset_0x015FDA
