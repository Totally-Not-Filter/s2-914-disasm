...
; Offset_0x01C3D4:
                ...
                bra.w   Jmp_00_To_MarkObjGone_2                ; Offset_0x01C852                                    
;-------------------------------------------------------------------------------   
Offset_0x01C3EA:
...
Offset_0x01C3F6:
                ...
                bsr.w   Jmp_05_To_ModifySpriteAttr_2P          ; Offset_0x01C846
                ...
                bsr.w   Jmp_00_To_SingleObjectLoad_2           ; Offset_0x01C840
                bne.s   Offset_0x01C450
...
Offset_0x01C4F6:
                bsr.w   Offset_0x01C522
                lea     (Offset_0x01C73A).l, A2
                btst    #$00, Obj_Map_Id(A0)                             ; $001A
                beq.s   Offset_0x01C50E
                lea     (Offset_0x01C76B).l, A2
Offset_0x01C50E:
                ...
                moveq   #$08, D3
                move.w  (A7)+, D4
                bra.w   Platform_Object_2                      ; Offset_0x014D5A
;-------------------------------------------------------------------------------                  
Offset_0x01C520:
                rts
Offset_0x01C522:
...
Offset_0x01C640:
                ...
                bsr.w   Jmp_00_To_ObjectFall                   ; Offset_0x01C84C
