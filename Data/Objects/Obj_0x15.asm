...
Offset_0x00CF50:
                move.w  #$0200, D0
                bra.w   DisplaySprite_Param                    ; Offset_0x01211A
;------------------------------------------------------------------------------- 
Offset_0x00CF58:
...
Offset_0x00CFF0:
                ...
                bsr.w   SingleObjectLoad_2                     ; Offset_0x013BC0
                bne.w   Offset_0x00D0C0
...
Offset_0x00D0EC:
                ...
                addq.b  #$01, D3
                move.w  (A7)+, D4
                bsr.w   Platform_Object_3                      ; Offset_0x014DB2
                bra.w   Offset_0x00D2A8
Offset_0x00D10C:
                moveq   #$00, D0
                moveq   #$00, D1
...
Offset_0x00D12C:
                move.w  #$00D7, D0
                jsr     (Play_Sfx_Ex).l                          ; Offset_0x00191E
                moveq   #$40, D0
                bra.s   Offset_0x00D15E
Offset_0x00D13A:
                cmpi.b  #$20, D1
                beq.w   Offset_0x00D208
                cmpi.b  #$30, D1
...
Offset_0x00D15E:
                ...
                add.w   D1, D0
Offset_0x00D17C:
                bsr.w   Jmp_01_To_CalcSine                     ; Offset_0x00D594
...
Offset_0x00D2A8:
                ...
                bra.w   DisplaySprite                          ; Offset_0x0120DE
Offset_0x00D2B2:
                move.w  Obj_Control_Var_0E(A0), D0                       ; $003A
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x00D2CA
                bra.w   DisplaySprite                          ; Offset_0x0120DE
Offset_0x00D2CA:
                move.l  Obj_Control_Var_04(A0), A1                       ; $0030
                bsr.w   DeleteObject_A1                        ; Offset_0x0120D2
                bra.w   DeleteObject                           ; Offset_0x0120D0
;-------------------------------------------------------------------------------                 
Offset_0x00D2D6:
                bra.w   DisplaySprite                          ; Offset_0x0120DE
;-------------------------------------------------------------------------------                 
Offset_0x00D2DA:
                ...
                andi.b  #$18, D0
                beq.w   Offset_0x00D390
                tst.b   ($FFFFFE78).w
                bne.w   Offset_0x00D390
                bsr.w   SingleObjectLoad_2                     ; Offset_0x013BC0
...
Offset_0x00D39C:
                ...
                bsr.w   SpeedToPos                             ; Offset_0x011F96
...
Offset_0x00D3EA:
                ...
                move.w  (A7)+, D4
                bsr.w   Platform_Object_3                      ; Offset_0x014DB2
                bra.w   MarkObjGone                            ; Offset_0x011FBC
;-------------------------------------------------------------------------------                 
Offset_0x00D402:
                move.w  Obj_X(A0), -(A7)                                 ; $0008
                bsr.w   SpeedToPos                             ; Offset_0x011F96
