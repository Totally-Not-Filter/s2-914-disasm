...
Offset_0x01CAD8:
                bsr.w   Jmp_07_To_ModifySpriteAttr_2P          ; Offset_0x01CD10
...
Offset_0x01CB30:
                ...
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Jmp_06_To_DeleteObject                 ; Offset_0x01CD0A
                bra.w   Jmp_05_To_DisplaySprite                ; Offset_0x01CD04
Offset_0x01CB60:
                moveq   #$00, D0
                move.b  Obj_Subtype(A0), D0                              ; $0028
                andi.w  #$000F, D0
...
;-------------------------------------------------------------------------------                 
Offset_0x01CBEE:
                bsr.w   Jmp_03_To_SpeedToPos                   ; Offset_0x01CD16
                moveq   #$08, D1
