...
Offset_0x01DA84:
                ...
                bsr.w   Jmp_09_To_ModifySpriteAttr_2P          ; Offset_0x01DD64
...
;-------------------------------------------------------------------------------                
Offset_0x01DAE6:
                lea     (Fireball_Animate_Data).l, A1            ; Offset_0x01DCA6
                bsr.w   Jmp_01_To_AnimateSprite                ; Offset_0x01DD5E
                bra.w   Jmp_06_To_MarkObjGone                  ; Offset_0x01DD52
;-------------------------------------------------------------------------------                
Offset_0x01DAF4:
                cmpi.b  #$05, Obj_Ani_Time(A0)                           ; $001E
                bne.s   Offset_0x01DB24
                bsr.w   Jmp_03_To_SingleObjectLoad_2           ; Offset_0x01DD58
...
Offset_0x01DC84:
                ...
                move.l  A1, -(A7)
                bsr.w   Fire_FindFloor                         ; Offset_0x019BAA
                move.l  (A7)+, A1
