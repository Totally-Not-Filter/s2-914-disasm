...
Offset_0x0200B4:
                ...
                bsr.w   Jmp_10_To_ModifySpriteAttr_2P          ; Offset_0x020288
...
Offset_0x02010E:
                lea     (Arrow_Shooter_Animate_Data).l, A1       ; Offset_0x0201F6
                bsr.w   Jmp_02_To_AnimateSprite                ; Offset_0x020282
                bra.w   Jmp_0D_To_MarkObjGone                  ; Offset_0x02027C
Offset_0x02011C:
...
;-------------------------------------------------------------------------------  
Offset_0x020132:
                bsr.w   Jmp_02_To_SingleObjectLoad             ; Offset_0x020276
...
;-------------------------------------------------------------------------------  
Offset_0x0201C6:
                bsr.w   Jmp_09_To_SpeedToPos                   ; Offset_0x02028E
                btst    #$00, Obj_Status(A0)                             ; $0022
                bne.s   Offset_0x0201E6
                moveq   #-$08, D3
                bsr.w   Object_HitWall_Left                    ; Offset_0x019E00
                tst.w   D1
                bmi.w   Offset_0x0201E2
                bra.w   Jmp_0D_To_MarkObjGone                  ; Offset_0x02027C
Offset_0x0201E2:
                bra.w   Jmp_0C_To_DeleteObject                 ; Offset_0x020270
Offset_0x0201E6:
                moveq   #$08, D3
                bsr.w   Object_HitWall_Right                   ; Offset_0x019C7A
                tst.w   D1
                bmi.w   Offset_0x0201E2
                bra.w   Jmp_0D_To_MarkObjGone                  ; Offset_0x02027C              
;-------------------------------------------------------------------------------  
