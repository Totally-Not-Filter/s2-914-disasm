...
;-------------------------------------------------------------------------------                 
Offset_0x01A3C4:
                lea     (Oxygen_Bubbles_Animate_Data).l, A1      ; Offset_0x01A64E
...
Offset_0x01A3DE:
                ...
                bra.w   Offset_0x01A43E
Offset_0x01A3F6:
                move.b  Obj_Angle(A0), D0                                ; $0026
                addq.b  #$01, Obj_Angle(A0)                              ; $0026
                andi.w  #$007F, D0
                lea     (Offset_0x018020).l, A1
                move.b  $00(A1, D0), D0
                ext.w   D0
                ...
                bsr.w   Offset_0x01A5A2
                cmpi.b  #$06, Obj_Routine(A0)                            ; $0024
                beq.s   Offset_0x01A43E
Offset_0x01A428:
                bsr.w   Jmp_01_To_SpeedToPos                   ; Offset_0x01A750
...
;-------------------------------------------------------------------------------                 
Offset_0x01A45C:
                bra.w   Jmp_01_To_DeleteObject                 ; Offset_0x01A74A
;-------------------------------------------------------------------------------                 
Offset_0x01A460:
                ...
                move.w  (Water_Level).w, D0                          ; $FFFFF646
                cmp.w   Obj_Y(A0), D0                                    ; $000C
                bcc.w   Offset_0x01A56E
                tst.b   Obj_Flags(A0)                                    ; $0001
                bpl.w   Offset_0x01A56E
                subq.w  #$01, Obj_Control_Var_0C(A0)                     ; $0038
                bpl.w   Offset_0x01A562
...
Offset_0x01A4CA:
                ...
                bsr.w   SingleObjectLoad                       ; Offset_0x013BAA
...
Offset_0x01A56E:
                ...
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Jmp_01_To_DeleteObject                 ; Offset_0x01A74A
                move.w  (Water_Level).w, D0                          ; $FFFFF646
                cmp.w   Obj_Y(A0), D0                                    ; $000C
                bcs.w   Jmp_01_To_DisplaySprite                ; Offset_0x01A744
                rts                
;-------------------------------------------------------------------------------
Offset_0x01A590:
