...
Offset_0x00F72E:
                ...
                addi.w  #$000B, D1
                bsr.w   Exit_Plaform                           ; Offset_0x014FB8
                btst    #$03, Obj_Status(A1)                             ; $0022
                bne.w   Offset_0x00F758
                clr.b   Obj_Routine_2(A0)                                ; $0025
                bra.w   Offset_0x00F812
Offset_0x00F758:
                move.w  #$0010, D3
                move.w  Obj_X(A0), D2                                    ; $0008
                bsr.w   Player_On_Platform                     ; Offset_0x014C62
                bra.w   Offset_0x00F812
Offset_0x00F768:
                bsr.w   ObjectFall                             ; Offset_0x011F6A
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                tst.w   D1
                bpl.w   Offset_0x00F812
...
Offset_0x00F788:
                move.w  #$001A, D1
                move.w  #$000F, D2
                bsr.w   Offset_0x00FA4E
                beq.w   Offset_0x00F7F8
...
Offset_0x00F7A6:
                ...
                bsr.w   Player_On_Spiral                       ; Offset_0x014EE4
                move.b  #$02, Obj_Routine_2(A0)                          ; $0025
                bra.w   Offset_0x00F812
Offset_0x00F7BC:
                tst.w   D0
                beq.w   Offset_0x00F7E2
...
Offset_0x00F812:
                lea     (Monitors_Animate_Data).l, A1            ; Offset_0x00FAC8
                bsr.w   AnimateSprite                          ; Offset_0x01212E
Offset_0x00F81C:
