...
Offset_0x020B56:
                ...
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Jmp_0E_To_DeleteObject                 ; Offset_0x020D62
                tst.w   (Debug_Mode_Flag_Index).w                    ; $FFFFFE08
                beq.s   Offset_0x020B74
                bsr.w   Jmp_0A_To_DisplaySprite                ; Offset_0x020D5C
Offset_0x020B74:
...
Offset_0x020BF2:
                lea     (Offset_0x020C94).l, A3
                moveq   #$03, D6
Offset_0x020BFA:
                bsr.w   Jmp_03_To_SingleObjectLoad             ; Offset_0x020D68
                bne.w   Offset_0x020C86
                _move.b #$2C, 0(A1)                                 ; $0000
                move.b  #$04, Obj_Routine(A1)                            ; $0024
                move.w  Obj_X(A2), Obj_X(A1)                      ; $0008, $0008
                move.w  Obj_Y(A2), Obj_Y(A1)                      ; $000C, $000C
                bsr.w   Jmp_01_To_PseudoRandomNumber           ; Offset_0x020D6E
                andi.w  #$000F, D0
                subq.w  #$08, D0
...
Offset_0x020CC2:
                ...
                bsr.w   Jmp_06_To_CalcSine                     ; Offset_0x020D74
                asr.w   #$06, D0
...
Offset_0x020D20:
                ...
                bpl.w   Jmp_0E_To_DeleteObject                 ; Offset_0x020D62
                bra.w   Jmp_0A_To_DisplaySprite                ; Offset_0x020D5C              
;-------------------------------------------------------------------------------
