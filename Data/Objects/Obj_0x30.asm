...
Offset_0x01E39E:
                ...
                bclr    #$07, $02(A2, D0)
Offset_0x01E3B0:
                bra.w   Jmp_09_To_DeleteObject                 ; Offset_0x01E540       
;-------------------------------------------------------------------------------
Offset_0x01E3B4:
                ...
                tst.b   ($FFFFEEBC).w
                beq.w   Jmp_03_To_MarkObjGone_3                ; Offset_0x01E54C
                rts     
;-------------------------------------------------------------------------------
Offset_0x01E3D8:
...
Offset_0x01E3E2:
                ...
                bsr.w   Jmp_00_To_SolidObject_2                ; Offset_0x01E558
                bra.w   Offset_0x01E552    
;-------------------------------------------------------------------------------
Offset_0x01E3FA:
                move.w  #$00CB, D1
                move.w  #$0078, D2
...
Offset_0x01E45A:             
                ...
                move.w  #$002E, D2
                move.w  Obj_X(A0), D4                                    ; $0008
                lea     (Offset_0x01E474).l, A2
                bsr.w   Jmp_00_To_SolidObject_3                ; Offset_0x01E55E
                bra.w   Offset_0x01E552          
;-------------------------------------------------------------------------------
Offset_0x01E474:
