...
Offset_0x01DFE2:
                bsr.w   Jmp_0A_To_ModifySpriteAttr_2P          ; Offset_0x01E334
...
Offset_0x01DFF2:
                ...
                bsr.w   Jmp_00_To_SolidObject                  ; Offset_0x01E340
                move.b  Obj_Status(A0), D0                               ; $0022
                andi.b  #$18, D0
                bne.s   Offset_0x01E02C
Offset_0x01E028:
                bra.w   Jmp_07_To_MarkObjGone                  ; Offset_0x01E32E
Offset_0x01E02C:
                cmpi.b  #$18, D0
...
Offset_0x01E0AA:
                andi.b  #$10, D0
                beq.w   Offset_0x01E028
                cmpi.b  #$02, Obj_Control_Var_07(A0)                     ; $0033
                bne.w   Offset_0x01E028
                lea     (Obj_Memory_Address+$0040).w, A1             ; $FFFFB040
                bsr.s   Offset_0x01E078
Offset_0x01E0C2:
                ...
                bsr.w   Jmp_00_To_Smash_Object                 ; Offset_0x01E33A
                bsr.w   Offset_0x01E118   
;-------------------------------------------------------------------------------
Offset_0x01E0DA:
                bsr.w   Jmp_06_To_SpeedToPos                   ; Offset_0x01E346
                addi.w  #$0018, Obj_Speed_Y(A0)                          ; $0012
                tst.b   Obj_Flags(A0)                                    ; $0001
                bpl.w   Jmp_08_To_DeleteObject                 ; Offset_0x01E322
                bra.w   Jmp_06_To_DisplaySprite                ; Offset_0x01E31C        
;-------------------------------------------------------------------------------
...
;-------------------------------------------------------------------------------
Offset_0x01E118:
                bsr.w   Jmp_00_To_SingleObjectLoad             ; Offset_0x01E328
...
Offset_0x01E140:
                ...
                moveq   #$0A, D2
Offset_0x01E154:
                jsr     (AddPoints).l                            ; Offset_0x0394D0
                lsr.w   #$01, D2
