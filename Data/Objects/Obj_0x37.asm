...
Offset_0x00F1A6:
                ...
                bsr.w   ModifySpriteAttr_2P_A1                 ; Offset_0x0129AA
                ...
                move.w  D4, D0
                bsr.w   Jmp_03_To_CalcSine                     ; Offset_0x00F6A8
                move.w  D4, D2
                lsr.w   #$08, D2
                asl.w   D2, D0
                asl.w   D2, D1
...
Offset_0x00F24A:
                ...
                jsr     (Ring_FindFloor).l                       ; Offset_0x019BD0
                tst.w   D1
...
Offset_0x00F29C:
                ...
                bsr.w   Add_Rings                              ; Offset_0x00F12E
;-------------------------------------------------------------------------------                
Offset_0x00F2B0:
                lea     (Rings_Animate_Data).l, A1               ; Offset_0x00F43C
