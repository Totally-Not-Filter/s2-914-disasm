...
Offset_0x01F872:
                bsr.w   Jmp_0E_To_ModifySpriteAttr_2P          ; Offset_0x01FC62
...
Offset_0x01F88E:
                ...
                bsr.w   Jmp_04_To_SolidObject                  ; Offset_0x01FC6E
                move.b  Obj_Status(A0), D0                               ; $0022
                andi.b  #$18, D0
                bne.s   Offset_0x01F8C8
Offset_0x01F8C4:
                bra.w   Jmp_0B_To_MarkObjGone                  ; Offset_0x01FC50
Offset_0x01F8C8:
                cmpi.b  #$18, D0
...
Offset_0x01F950:
                andi.b  #$10, D0
                beq.w   Offset_0x01F8C4
                cmpi.b  #$02, Obj_Control_Var_07(A0)                     ; $0033
                bne.w   Offset_0x01F8C4
                lea     (Obj_Memory_Address+$0040).w, A1             ; $FFFFB040
                move.w  Obj_Control_Var_0A(A0), D1                       ; $0036
                bsr.s   Offset_0x01F920
Offset_0x01F96C:
                andi.b  #$E7, Obj_Status(A0)                             ; $0022
                bsr.w   Jmp_06_To_SingleObjectLoad_2           ; Offset_0x01FC56
...
Offset_0x01F990:
                lea     (Break_Boost_Data).l, A4                 ; Offset_0x01FAB4
                addq.b  #$01, Obj_Map_Id(A0)                             ; $001A
                moveq   #$0F, D1
                move.w  #$0018, D2
                bsr.w   Jmp_01_To_Smash_Object                 ; Offset_0x01FC68     
;------------------------------------------------------------------------------- 
Offset_0x01F9A4:
                bsr.w   Jmp_08_To_SpeedToPos                   ; Offset_0x01FC74
                addi.w  #$0018, Obj_Speed_Y(A0)                          ; $0012
                tst.b   Obj_Flags(A0)                                    ; $0001
                bpl.w   Jmp_0B_To_DeleteObject                 ; Offset_0x01FC4A
                bra.w   Jmp_07_To_DisplaySprite                ; Offset_0x01FC44 
;------------------------------------------------------------------------------- 
Offset_0x01F9BA:
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                ...
                beq.w   Jmp_04_To_MarkObjGone_3                ; Offset_0x01FC5C
                rts
Offset_0x01F9DC:
                moveq   #$00, D0
                move.b  (A4), D0
