...
Offset_0x037DC4:
                ...
                bsr.w   Jmp_3C_To_ModifySpriteAttr_2P          ; Offset_0x038074
...
Offset_0x037E12:
                ...
                jmp     (SolidObject).l                          ; Offset_0x0147F4
Offset_0x037E30:
...
Offset_0x037E4E:
                ...
                move.w  #$0008, D3
                move.w  Obj_X(A0), D4                                    ; $0008
                jsr     (SolidObject).l                          ; Offset_0x0147F4
                lea     (Egg_Prison_Animate_Data).l, A1          ; Offset_0x037FC0
...
Offset_0x037FA8:
                ...
                jsr     (Load_Level_Results).l                   ; Offset_0x0146A2
                jmp     (DeleteObject).l                         ; Offset_0x0120D0
Offset_0x037FBE:
                rts
;-------------------------------------------------------------------------------
