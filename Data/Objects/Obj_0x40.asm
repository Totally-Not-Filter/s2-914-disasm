...
; Offset_0x020D7C:
                ...
                bra.w   Jmp_0F_To_MarkObjGone                  ; Offset_0x021028       
;-------------------------------------------------------------------------------     
Offset_0x020D8E:
...
Offset_0x020D98:
                ...
                bsr.w   Jmp_12_To_ModifySpriteAttr_2P          ; Offset_0x021034
...
;-------------------------------------------------------------------------------                  
Offset_0x020DD4:
                lea     (Diagonal_Spring_Animate_Data).l, A1     ; Offset_0x020FF4
                bsr.w   Jmp_03_To_AnimateSprite                ; Offset_0x02102E
                move.w  #$0027, D1
                move.w  #$0008, D2
...
Offset_0x020DF8:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   Jmp_00_To_SolidObject_3_A1             ; Offset_0x02103A
