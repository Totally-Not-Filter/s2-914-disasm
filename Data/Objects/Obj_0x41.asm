...
Offset_0x013C08:
                ...
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   DeleteObject                           ; Offset_0x0120D0
                bra.w   DisplaySprite                          ; Offset_0x0120DE
;-------------------------------------------------------------------------------
Offset_0x013C20:
...
Offset_0x013D04:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   SolidObject_2_A1                       ; Offset_0x01486A
...
Offset_0x013D2C:
                ...
                bsr.s   Offset_0x013D50
Offset_0x013D44:
                lea     (Springs_Animate_Data).l, A1             ; Offset_0x01436E
                bra.w   AnimateSprite                          ; Offset_0x01212E
;------------------------------------------------------------------------------- 
                rts
;-------------------------------------------------------------------------------
Offset_0x013D50:
...
Offset_0x013F98:
                ...
                cmp.w   D0, D4
                bcs.w   Offset_0x013FC4
                cmp.w   D1, D4
                bcc.w   Offset_0x013FC4
...
Offset_0x013FDE:
                ...
                move.w  Obj_X(A1), D4                                    ; $0008
                cmp.w   D0, D4
                bcs.w   Offset_0x014006
                cmp.w   D1, D4
                bcc.w   Offset_0x014006
                move.w  Obj_Y(A1), D4                                    ; $000C
                cmp.w   D2, D4
                bcs.w   Offset_0x014006
                cmp.w   D3, D4
...
Offset_0x0140F4:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   SolidObject_3_A1                       ; Offset_0x0148C2
                btst    #$03, Obj_Status(A0)                             ; $0022
