...
Offset_0x01F494:
                ...
                bclr    #$07, $02(A2, D0)
                bset    #$00, $02(A2, D0)
                bne.w   Jmp_0A_To_DeleteObject                 ; Offset_0x01F72C
Offset_0x01F4B0:
                ...
                bsr.w   Jmp_0C_To_ModifySpriteAttr_2P          ; Offset_0x01F73E
                ...
                bsr.w   Jmp_01_To_SingleObjectLoad             ; Offset_0x01F732
...
Offset_0x01F598:
                bsr.w   Offset_0x01F658
                bra.w   Jmp_09_To_MarkObjGone                  ; Offset_0x01F738    
;------------------------------------------------------------------------------- 
Offset_0x01F5A0:
                move.w  Obj_X(A0), -(A7)                                 ; $0008
                bsr.w   Jmp_07_To_SpeedToPos                   ; Offset_0x01F756
...
Offset_0x01F60C:
                ...
                move.w  #$0011, D3
                move.w  (A7)+, D4
                bsr.w   Jmp_02_To_SolidObject                  ; Offset_0x01F744
                bsr.w   Offset_0x01F658
                bra.w   Jmp_09_To_MarkObjGone                  ; Offset_0x01F738
Offset_0x01F62C:
                move.w  (A7)+, D4
                ...
                bclr    #$07, $02(A2, D0)
Offset_0x01F640:
                bra.w   Jmp_0A_To_DeleteObject                 ; Offset_0x01F72C    
;------------------------------------------------------------------------------- 
Offset_0x01F644:
