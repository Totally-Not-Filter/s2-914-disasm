...
Offset_0x027556:
                ...
                bsr.w   Offset_0x02757C
                lea     (Batbot_Animate_Data).l, A1              ; Offset_0x02776E
                bsr.w   Jmp_0A_To_AnimateSprite                ; Offset_0x02797E
                bra.w   Jmp_1E_To_MarkObjGone                  ; Offset_0x027978                    
;-------------------------------------------------------------------------------  
Offset_0x027576:
...
;------------------------------------------------------------------------------- 
Offset_0x0275C4:
                bsr.w   Offset_0x0276C2
                bsr.w   Offset_0x027664
                bsr.w   Offset_0x0275E4
                bsr.w   Jmp_11_To_SpeedToPos                   ; Offset_0x027984
                lea     (Batbot_Animate_Data).l, A1              ; Offset_0x02776E
                bsr.w   Jmp_0A_To_AnimateSprite                ; Offset_0x02797E
                bra.w   Jmp_1E_To_MarkObjGone                  ; Offset_0x027978            
;-------------------------------------------------------------------------------    
