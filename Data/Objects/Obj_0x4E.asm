...
Offset_0x02799E:
                ...
                bsr.w   Jmp_01_To_ObjectFall                   ; Offset_0x027C78
...
Offset_0x0279EE:
                ...
                lea     (Crocobot_Animate_Data).l, A1            ; Offset_0x027AA2
                bsr.w   Jmp_0B_To_AnimateSprite                ; Offset_0x027C72
                bra.w   Jmp_1F_To_MarkObjGone                  ; Offset_0x027C6C       
;-------------------------------------------------------------------------------       
Offset_0x027A0A:
...
;-------------------------------------------------------------------------------
Offset_0x027A32:
                bsr.w   Offset_0x027A6A
                bsr.w   Jmp_12_To_SpeedToPos                   ; Offset_0x027C7E
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                cmpi.w  #$FFF8, D1
