...
Offset_0x027F48:
                ...
                bsr.w   Jmp_03_To_ObjectFall                   ; Offset_0x02808A
...
Offset_0x027F9E:
                ...
                lea     (Dinobot_Animate_Data).l, A1             ; Offset_0x028044
                bsr.w   Jmp_0D_To_AnimateSprite                ; Offset_0x028084
                move.w  Obj_X(A0), D0                                    ; $0008
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x027FCE
                bra.w   Jmp_18_To_DisplaySprite                ; Offset_0x028078
Offset_0x027FCE:
                lea     ($FFFFFC00).w, A2
                moveq   #$00, D0
                ...
                bclr    #$07, $02(A2, D0)
Offset_0x027FE0:
                bra.w   Jmp_1A_To_DeleteObject                 ; Offset_0x02807E    
;-------------------------------------------------------------------------------     
Offset_0x027FE4:
...
;-------------------------------------------------------------------------------  
Offset_0x02800C:
                bsr.w   Jmp_13_To_SpeedToPos                   ; Offset_0x028090
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                cmpi.w  #$FFF8, D1
