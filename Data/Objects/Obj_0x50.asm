...
Offset_0x0280B2:
                ...
                bsr.w   Jmp_09_To_SingleObjectLoad             ; Offset_0x02861C
                bne.s   Offset_0x028170
                _move.b #$50, 0(A1)                                 ; $0000
...
;-------------------------------------------------------------------------------
Offset_0x028170:
                lea     (Aquis_Animate_Data).l, A1               ; Offset_0x02854C
                bsr.w   Jmp_0E_To_AnimateSprite                ; Offset_0x028628
                moveq   #$00, D0
                move.b  Obj_Routine_2(A0), D0                            ; $0025
                move.w  Offset_0x028190(PC, D0), D1
                jsr     Offset_0x028190(PC, D1)
                bsr.w   Offset_0x028384
                bra.w   Jmp_21_To_MarkObjGone                  ; Offset_0x028622       
Offset_0x028190:
...
Offset_0x028196:
                ...
                tst.b   (A1)
                beq.w   Jmp_1B_To_DeleteObject                 ; Offset_0x028616
                cmpi.b  #$50, (A1)
                bne.w   Jmp_1B_To_DeleteObject                 ; Offset_0x028616
                btst    #$07, Obj_Status(A1)                             ; $0022
                bne.w   Jmp_1B_To_DeleteObject                 ; Offset_0x028616
                lea     (Aquis_Animate_Data).l, A1               ; Offset_0x02854C
                bsr.w   Jmp_0E_To_AnimateSprite                ; Offset_0x028628
                bra.w   Jmp_19_To_DisplaySprite                ; Offset_0x028610   
;-------------------------------------------------------------------------------
Offset_0x0281C0:
                bsr.w   Offset_0x0284A8
                bsr.w   Jmp_14_To_SpeedToPos                   ; Offset_0x028634
                lea     (Aquis_Animate_Data).l, A1               ; Offset_0x02854C
                bsr.w   Jmp_0E_To_AnimateSprite                ; Offset_0x028628
                bra.w   Jmp_21_To_MarkObjGone                  ; Offset_0x028622     
;-------------------------------------------------------------------------------
Offset_0x0281D6:
                bsr.w   Offset_0x028210
                bsr.w   Jmp_14_To_SpeedToPos                   ; Offset_0x028634
                bsr.w   Offset_0x02848A
                bsr.w   Offset_0x028330
                bsr.w   Offset_0x0282C8
                rts    
;-------------------------------------------------------------------------------
Offset_0x0281EC:
                bsr.w   Offset_0x028210
                bsr.w   Jmp_14_To_SpeedToPos                   ; Offset_0x028634
                bsr.w   Offset_0x02848A
                bsr.w   Offset_0x028352
                rts 
;-------------------------------------------------------------------------------
Offset_0x0281FE:
                bsr.w   Jmp_04_To_ObjectFall                   ; Offset_0x02862E
                bsr.w   Offset_0x02848A
                bsr.w   Offset_0x028224
                bsr.w   Offset_0x0282A0
                rts
Offset_0x028210:
...
Offset_0x028524:
                ...
                move.w  #$2500, Obj_Art_VRAM(A1)                         ; $0002
Offset_0x028546:
                bra.w   Jmp_1B_To_DeleteObject                 ; Offset_0x028616
Offset_0x02854A:
                rts
;-------------------------------------------------------------------------------
