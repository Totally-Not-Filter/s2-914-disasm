...
Offset_0x02CF30:
                ...
                bsr.w   CNz_Boss_Hit                           ; Offset_0x028DF2
                bsr.w   Offset_0x02D162
                bsr.w   Offset_0x02D23A
                lea     (CNz_Boss_Animate_Data).l, A1            ; Offset_0x02D56C
                bsr.w   Boss_AnimateSprite                     ; Offset_0x028EB2
                bra.w   Jmp_20_To_DisplaySprite                ; Offset_0x02D718     
;-------------------------------------------------------------------------------
Offset_0x02CF4E:
...
Offset_0x02D02E:
                ...
                bgt.w   Offset_0x02CF30
                move.b  #$00, (Boss_Animate_Buffer+$03).w            ; $FFFFF743
                move.b  #$00, (Boss_Animate_Buffer+$09).w            ; $FFFFF749
                move.b  #$00, Obj_Ani_Boss_Routine(A0)                   ; $0026
                bra.w   Offset_0x02CF30
Offset_0x02D04E:
                bsr.w   Jmp_0D_To_SingleObjectLoad             ; Offset_0x02D724
...
Offset_0x02D380:
                ...
                bne.w   Jmp_20_To_DisplaySprite                ; Offset_0x02D718
                addq.b  #$02, Obj_Routine_2(A0)                          ; $0025
...
Offset_0x02D502:
                ...
                move.b  #$98, Obj_Col_Flags(A0)                          ; $0020
                bsr.w   Jmp_14_To_SingleObjectLoad_2           ; Offset_0x02D72A
...
Offset_0x02D550:
                bsr.w   Offset_0x02D48E
                lea     (CNz_Boss_Animate_Data).l, A1            ; Offset_0x02D56C
                bsr.w   Jmp_15_To_AnimateSprite                ; Offset_0x02D730
                cmpi.w  #$0705, Obj_Y(A0)                                ; $000C
                bcs.w   Jmp_20_To_DisplaySprite                ; Offset_0x02D718
                bra.w   Jmp_23_To_DeleteObject                 ; Offset_0x02D71E
;-------------------------------------------------------------------------------
