...
Offset_0x02B376:
                ...
                bra.w   Jmp_1D_To_DisplaySprite                ; Offset_0x02B9D4    
;-------------------------------------------------------------------------------
Offset_0x02B384:
                ...
                bsr.w   Jmp_0A_To_SingleObjectLoad             ; Offset_0x02B9E0
...
Offset_0x02B3D0:
                bsr.w   Boss_Hit                               ; Offset_0x028E10
                bsr.w   Offset_0x02B504
                lea     (HTz_Boss_Animate_Data).l, A1            ; Offset_0x02B82E
...
Offset_0x02B450:
                ...
                move.w  Obj_Y(A0), Obj_Y(A1)                      ; $000C, $000C
                move.b  #$AE, D0
                bsr.w   Jmp_01_To_Play_Sfx                     ; Offset_0x02B9EC
Offset_0x02B47E:
                tst.b   Obj_Control_Var_00(A0)                           ; $002C
...
Offset_0x02B576:
                ...
                lea     (HTz_Boss_Animate_Data).l, A1            ; Offset_0x02B82E
                bsr.w   Jmp_13_To_AnimateSprite                ; Offset_0x02B9F2
                bra.w   Jmp_26_To_MarkObjGone                  ; Offset_0x02B9E6     
;-------------------------------------------------------------------------------
Offset_0x02B58C:
                moveq   #$00, D0
                move.b  Obj_Routine_2(A0), D0                            ; $0025
...
;-------------------------------------------------------------------------------
Offset_0x02B62E:
                bsr.w   Offset_0x02B698
                bsr.w   Jmp_03_To_ObjHitFloor                  ; Offset_0x02B9F8
                tst.w   D1
...
Offset_0x02B6CA:
                ...
                andi.b  #$1F, D0
                bne.w   Jmp_1D_To_DisplaySprite                ; Offset_0x02B9D4
                bsr.w   Offset_0x02B75A
                bra.w   Jmp_1D_To_DisplaySprite                ; Offset_0x02B9D4
Offset_0x02B6FE:
                bsr.w   Boss_Defeated                          ; Offset_0x028F7A
                bra.w   Jmp_1D_To_DisplaySprite                ; Offset_0x02B9D4
...
Offset_0x02B746:
                ...
                bra.w   Jmp_20_To_DeleteObject                 ; Offset_0x02B9DA
Offset_0x02B756:
                bra.w   Jmp_1D_To_DisplaySprite                ; Offset_0x02B9D4
Offset_0x02B75A:
                bsr.w   Jmp_0A_To_SingleObjectLoad             ; Offset_0x02B9E0
