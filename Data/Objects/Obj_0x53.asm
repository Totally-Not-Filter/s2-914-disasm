...
Offset_0x02DDFE:
                bsr.w   Jmp_0E_To_SingleObjectLoad             ; Offset_0x02E3CC
...
Offset_0x02DEDA:
                bsr.w   Offset_0x02DEE6
                bsr.w   Offset_0x02DF90
                bra.w   Jmp_21_To_DisplaySprite                ; Offset_0x02E3C0
Offset_0x02DEE6:
...
Offset_0x02DFEC:
                bsr.w   Jmp_09_To_ObjectFall                   ; Offset_0x02E3E4
...
Offset_0x02E004:
                ...
                addq.b  #$02, Obj_Routine(A0)                            ; $0024
                bsr.w   Offset_0x02E0C2
Offset_0x02E026:
                bsr.w   Offset_0x02E038
                lea     (Mz_Boss_Animate_Data).l, A1             ; Offset_0x02E1F0
                bsr.w   Jmp_16_To_AnimateSprite                ; Offset_0x02E3D8
                bra.w   Jmp_21_To_DisplaySprite                ; Offset_0x02E3C0
Offset_0x02E038:
...
Offset_0x02E064:
                ...
                beq.w   Jmp_21_To_DisplaySprite                ; Offset_0x02E3C0
                moveq   #-$01, D0
...
Offset_0x02E10E:
                move.b  #$C4, D0
                bsr.w   Jmp_03_To_Play_Sfx                     ; Offset_0x02E3D2
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                subi.b  #$01, Obj_Control_Var_00(A1)                     ; $002C
                bra.w   Jmp_24_To_DeleteObject                 ; Offset_0x02E3C6      
;-------------------------------------------------------------------------------  
...
;-------------------------------------------------------------------------------
Offset_0x02E1A2:
                bsr.w   Jmp_18_To_SpeedToPos                   ; Offset_0x02E3EA
                cmpi.w  #$2AB0, Obj_X(A0)                                ; $0008
                bcs.w   Jmp_24_To_DeleteObject                 ; Offset_0x02E3C6
                cmpi.w  #$2BF0, Obj_X(A0)                                ; $0008
                bcc.w   Jmp_24_To_DeleteObject                 ; Offset_0x02E3C6
                bra.w   Jmp_21_To_DisplaySprite                ; Offset_0x02E3C0   
;-------------------------------------------------------------------------------
Mz_Boss_Sub_03:                                                ; Offset_0x02E1BE
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                cmpi.b  #$54, (A1)
                bne.w   Jmp_24_To_DeleteObject                 ; Offset_0x02E3C6
                move.w  Obj_X(A1), Obj_X(A0)                      ; $0008, $0008
                move.w  Obj_Y(A1), Obj_Y(A0)                      ; $000C, $000C
                bclr    #$00, Obj_Flags(A0)                              ; $0001
                btst    #$00, Obj_Flags(A1)                              ; $0001
