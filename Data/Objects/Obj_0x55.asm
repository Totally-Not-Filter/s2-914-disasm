...
Offset_0x02E59C:
                ...
                addq.b  #$02, Obj_Boss_Routine(A0)                       ; $000A
Offset_0x02E5BE:
                bsr.w   Offset_0x02E5D4
                lea     (OOz_Boss_Animate_Data).l, A1            ; Offset_0x02EB5C
                bsr.w   Boss_AnimateSprite                     ; Offset_0x028EB2
                bsr.w   Offset_0x02E5F4
                bra.w   Jmp_22_To_DisplaySprite                ; Offset_0x02ECE8
Offset_0x02E5D4:
                bsr.w   Boss_Hit                               ; Offset_0x028E10
...
Offset_0x02E61A:
                bsr.w   Boss_Defeated                          ; Offset_0x028F7A
                bra.w   Jmp_22_To_DisplaySprite                ; Offset_0x02ECE8
Offset_0x02E622:
...
Offset_0x02E64A:
                ...
                bra.w   Jmp_25_To_DeleteObject                 ; Offset_0x02ECEE  
;-------------------------------------------------------------------------------
Offset_0x02E654:
                moveq   #$00, D0
                move.b  Obj_Ani_Boss_Routine(A0), D0                     ; $0026
...
Offset_0x02E71C:
                subi.w  #$0001, (Boss_Move_Buffer+$0C).w             ; $FFFFF75C
                bne.w   Offset_0x02E804
                subi.b  #$01, Obj_Control_Var_0C(A0)                     ; $0038
                bmi.s   Offset_0x02E756
                bsr.w   Jmp_04_To_PseudoRandomNumber           ; Offset_0x02ED12
Offset_0x02E732:
                addq.b  #$01, D0
                andi.w  #$0003, D0
...
Offset_0x02E78C:
                ...
                bsr.w   Jmp_0F_To_SingleObjectLoad             ; Offset_0x02ECF4
                bne.w   Offset_0x02E804
                move.b  #$55, (A1)
                move.b  #$08, Obj_Boss_Routine(A1)                       ; $000A
                move.l  A0, Obj_Control_Var_08(A1)                       ; $0034
                move.b  #$EA, D0
                bsr.w   Jmp_04_To_Play_Sfx                     ; Offset_0x02ED00
...
Offset_0x02E7DE:
                ...
                rts
Offset_0x02E804:
                bsr.w   Offset_0x02E82A
                bsr.w   Offset_0x02E850
                bra.w   Jmp_22_To_DisplaySprite                ; Offset_0x02ECE8        
Offset_0x02E810:
                move.w  (Boss_Move_Buffer+$0C).w, D0                 ; $FFFFF75C
...
Offset_0x02E890:
                move.b  D3, D0
                bsr.w   Jmp_0B_To_CalcSine                     ; Offset_0x02ED1E
                asr.w   #$04, D1
                add.w   D5, D1
                asr.w   #$06, D0
                add.w   D6, D0
...
Offset_0x02E916:
                ...
                rts
Offset_0x02E930:
                bsr.w   Offset_0x02E996
                bra.w   Jmp_22_To_DisplaySprite                ; Offset_0x02ECE8
Offset_0x02E938:
                move.b  Obj_Map_Id(A0), D0                               ; $001A
                addi.b  #$40, D0
                move.b  D0, D3
                bsr.w   Offset_0x02E970
                move.w  D1, Obj_X(A0)                                    ; $0008
                move.w  D0, Obj_Y(A0)                                    ; $000C
...
;-------------------------------------------------------------------------------
Offset_0x02EA28:
                bsr.w   Offset_0x02EA48
                bsr.w   Jmp_19_To_SpeedToPos                   ; Offset_0x02ED24
                cmpi.w  #$2870, Obj_X(A0)                                ; $0008
                bcs.w   Jmp_25_To_DeleteObject                 ; Offset_0x02ECEE
                cmpi.w  #$2A10, Obj_X(A0)                                ; $0008
                bcc.w   Jmp_25_To_DeleteObject                 ; Offset_0x02ECEE
                bra.w   Jmp_22_To_DisplaySprite                ; Offset_0x02ECE8
Offset_0x02EA48:
                cmpi.w  #$0250, Obj_Y(A0)                                ; $000C
                bcs.s   Offset_0x02EA70
                tst.w   OOz_Robotnik_Pos_X(A0)                           ; $0010
                bmi.w   Offset_0x02EA72
                move.w  Obj_X(A0), D0                                    ; $0008
                cmpi.w  #$2980, D0
                bcc.s   Offset_0x02EA70
                cmpi.w  #$297C, D0
                bcs.w   Offset_0x02EA70
                move.w  #$2988, D1
...
Offset_0x02EA8A:
                ...
                bsr.w   Jmp_39_To_ModifySpriteAttr_2P          ; Offset_0x02ED18
...
Offset_0x02EAFC:
                ...
                bsr.w   Jmp_15_To_SingleObjectLoad_2           ; Offset_0x02ED06
...
Offset_0x02EB4A:
                lea     (OOz_Boss_Animate_Data).l, A1            ; Offset_0x02EB5C
                bsr.w   Jmp_17_To_AnimateSprite                ; Offset_0x02ED0C
                bra.w   Jmp_27_To_MarkObjGone                  ; Offset_0x02ECFA 
;-------------------------------------------------------------------------------
Offset_0x02EB58:
                bra.w   Jmp_25_To_DeleteObject                 ; Offset_0x02ECEE
;-------------------------------------------------------------------------------
