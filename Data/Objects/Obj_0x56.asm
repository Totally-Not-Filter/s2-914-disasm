...
Offset_0x02A6C6:
                ...
                bsr.w   Jmp_37_To_ModifySpriteAttr_2P          ; Offset_0x02B274
                jsr     (SingleObjectLoad_2).l                   ; Offset_0x013BC0
                bne.w   Offset_0x02A762
...
Offset_0x02A762:
                ...
                bsr.w   Jmp_06_To_ModifySpriteAttr_2P_A1       ; Offset_0x02B262
                move.b  #$04, Obj_Flags(A1)                              ; $0001
                move.b  #$20, Obj_Width(A1)                              ; $0019
...
Offset_0x02A9FA:
                ...
                bcs.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
                ...
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
Offset_0x02AA22:
...
Offset_0x02AA68:
                ...
                bpl.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
...
;-------------------------------------------------------------------------------
Offset_0x02AA8C:
                bsr.w   Offset_0x02AC1C
                bsr.w   Offset_0x02ABFA
...
Offset_0x02AABE:
                ...
                bsr.w   Jmp_07_To_ObjectFall                   ; Offset_0x02B27A
                bsr.w   Jmp_02_To_ObjHitFloor                  ; Offset_0x02B268
                tst.w   D1
                bpl.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
...
Offset_0x02AB12:
                ...
                tst.b   ($FFFFF7A7).w
                bne.w   Jmp_1F_To_DeleteObject                 ; Offset_0x02B24A
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244  
;-------------------------------------------------------------------------------   
Offset_0x02AB2C:
...
Offset_0x02AB32:
                ...
                bsr.w   Jmp_12_To_SingleObjectLoad_2           ; Offset_0x02B256
                bne.w   Offset_0x02ABA8
                _move.b #$56, 0(A1)                                 ; $0000
                move.l  A0, Obj_Control_Var_08(A1)                       ; $0034
                move.l  #GHz_Boss_Mappings, Obj_Map(A1) ; Offset_0x02B072, $0004
                move.w  #$25E8, Obj_Art_VRAM(A1)                         ; $0002
...
Offset_0x02AC64:
                moveq   #$64, D0
                bsr.w   Jmp_02_To_AddPoints                    ; Offset_0x02B26E
...
Offset_0x02AC8A:
                ...
                lea     (GHz_Boss_Animate_Data).l, A1            ; Offset_0x02B038
                bsr.w   Jmp_12_To_AnimateSprite                ; Offset_0x02B25C
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244       
;-------------------------------------------------------------------------------
Offset_0x02ACAE:
                moveq   #$00, D0
...
Offset_0x02AD0A:
                ...
                ble.w   Jmp_1F_To_DeleteObject                 ; Offset_0x02B24A
                move.b  #$04, Obj_Priority(A0)                           ; $0018
                addi.w  #$0001, Obj_Y(A0)                                ; $000C
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
Offset_0x02AD2C:
...
Offset_0x02AD6A:
                ...
                beq.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
                btst    #$02, Obj_Control_Var_01(A1)                     ; $002D
                bne.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
                move.w  Obj_X(A1), Obj_X(A0)                      ; $0008, $0008
                move.w  Obj_Y(A1), Obj_Y(A0)                      ; $000C, $000C
                addi.w  #$0008, Obj_Y(A0)                                ; $000C
                move.b  Obj_Status(A1), Obj_Status(A0)            ; $0022, $0022
                bmi.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244
                move.b  Obj_Flags(A1), Obj_Flags(A0)              ; $0001, $0001
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244 
;-------------------------------------------------------------------------------
Offset_0x02ADA8:
...
Offset_0x02AE3E:
                ...
                move.w  #$FE00, Obj_Speed(A0)                            ; $0010
Offset_0x02AE4A:
                lea     (GHz_Boss_Animate_Data_01).l, A1         ; Offset_0x02B146
                bsr.w   Jmp_12_To_AnimateSprite                ; Offset_0x02B25C
                bra.w   Jmp_1C_To_DisplaySprite                ; Offset_0x02B244     
;-------------------------------------------------------------------------------
Offset_0x02AE58:
...
Offset_0x02AF02:
                ...
                add.w   D1, Obj_Y(A0)                                    ; $000C
Offset_0x02AF20:
                bra.w   Jmp_25_To_MarkObjGone                  ; Offset_0x02B250    
;-------------------------------------------------------------------------------
Offset_0x02AF24:
                tst.b   Obj_Routine_2(A0)                                ; $0025
