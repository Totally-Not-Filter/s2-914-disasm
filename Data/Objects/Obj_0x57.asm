...
Offset_0x02C676:
                ...
                move.b  #$01, ($FFFFEEBD).w
                bsr.w   Offset_0x02C902
Offset_0x02C688:
                move.w  (Boss_Move_Buffer+$04).w, Obj_Y(A0)   ; $FFFFF754, $000C
                move.w  (Boss_Move_Buffer).w, Obj_X(A0)       ; $FFFFF750, $0008
                bsr.w   Offset_0x02C976
                lea     (DHz_Boss_Animate_Data).l, A1            ; Offset_0x02CB44
                bsr.w   Boss_AnimateSprite                     ; Offset_0x028EB2
                bsr.w   Offset_0x02C846
                bra.w   Jmp_1F_To_DisplaySprite                ; Offset_0x02CDF4      
;-------------------------------------------------------------------------------  
Offset_0x02C6AA:
                bsr.w   Boss_Move                              ; Offset_0x028E8C
                bsr.w   Offset_0x02C902
...
Offset_0x02C902:
                ...
                st      D2
Offset_0x02C916:
                bsr.w   Jmp_03_To_PseudoRandomNumber           ; Offset_0x02CE06
                swap    D1
                andi.w  #$01FF, D1
                addi.w  #$20F0, D1
                cmpi.w  #$2230, D1
                bgt.s   Offset_0x02C916
                bsr.w   Jmp_0C_To_SingleObjectLoad             ; Offset_0x02CE00
                bne.s   Offset_0x02C974
                move.b  #$57, (A1)
...
Offset_0x02C9F4:
                moveq   #$64, D0
                bsr.w   Jmp_04_To_AddPoints                    ; Offset_0x02CE0C
...
;-------------------------------------------------------------------------------                   
Offset_0x02CB2C:
                bsr.w   Jmp_08_To_ObjectFall                   ; Offset_0x02CE12
                subi.w  #$0028, DHz_Front_Drill_Pos_Y(A0)                ; $0012
                cmpi.w  #$06F0, Obj_Y(A0)                                ; $000C
                bgt.w   Jmp_22_To_DeleteObject                 ; Offset_0x02CDFA
                bra.w   Jmp_1F_To_DisplaySprite                ; Offset_0x02CDF4      
;-------------------------------------------------------------------------------
