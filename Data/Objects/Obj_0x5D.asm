...
Offset_0x029006:
                ...
                bsr.w   Jmp_36_To_ModifySpriteAttr_2P          ; Offset_0x02A696
                jsr     (SingleObjectLoad_2).l                   ; Offset_0x013BC0
                bne.w   Offset_0x029154
                _move.b #$5D, 0(A1)                                 ; $0000
                ...
                bsr.w   Jmp_05_To_ModifySpriteAttr_2P_A1       ; Offset_0x02A68A
                tst.b   Obj_Subtype(A0)                                  ; $0028
                bmi.w   Offset_0x029154
                jsr     (SingleObjectLoad_2).l                   ; Offset_0x013BC0
                bne.w   Offset_0x029154
                _move.b #$5D, 0(A1)                                 ; $0000
                move.l  A0, Obj_Control_Var_08(A1)                       ; $0034
...
;-------------------------------------------------------------------------------                
Offset_0x0291F6:
                bsr.w   Offset_0x02923A
                moveq   #$00, D0
                move.b  Obj_Routine_2(A0), D0                            ; $0025
                move.w  Offset_0x02922C(PC, D0), D1
                jsr     Offset_0x02922C(PC, D1)
                lea     (CPz_Boss_Animate_Data_1).l, A1          ; Offset_0x02A5B8
                jsr     (AnimateSprite).l                        ; Offset_0x01212E
...
Offset_0x0292B6:
                clr.w   Obj_Speed_Y(A0)                                  ; $0012
Offset_0x0292BA:
                bsr.w   Offset_0x029398
                bra.w   Offset_0x029318
;-------------------------------------------------------------------------------                
Offset_0x0292C2:
...
Offset_0x029384:
                moveq   #$64, D0
                bsr.w   Jmp_01_To_AddPoints                    ; Offset_0x02A690
...
Offset_0x0293BE:
                ...
                jsr     (SingleObjectLoad).l                     ; Offset_0x013BAA
                bne.s   Offset_0x029404
                _move.b #$58, 0(A1)                                 ; $0000
                move.w  Obj_X(A0), Obj_X(A1)                      ; $0008, $0008
                move.w  Obj_Y(A0), Obj_Y(A1)                      ; $000C, $000C
                jsr     (PseudoRandomNumber).l                   ; Offset_0x003944
                move.w  D0, D1
                moveq   #$00, D1
                move.b  D0, D1
                lsr.b   #$02, D1
...
Offset_0x0294E8:
                ...
                bgt.w   Jmp_1B_To_DisplaySprite                ; Offset_0x02A678
                bsr.w   Offset_0x029406
                move.b  #$F9, Obj_Control_Var_04(A0)                     ; $0030
                move.w  #$001E, Obj_Timer(A0)                            ; $002A
Offset_0x02950A:
                subq.w  #$01, Obj_Timer(A0)                              ; $002A
                bpl.w   Jmp_1B_To_DisplaySprite                ; Offset_0x02A678
                move.w  Obj_Speed(A0), D0                                ; $0010
                ...
                cmpi.l  #$05800000, D3
                bcc.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
                bra.w   Jmp_24_To_MarkObjGone                  ; Offset_0x02A684
;-------------------------------------------------------------------------------                
Offset_0x029540:
...
Offset_0x0295B0:
                jsr     (SingleObjectLoad).l                     ; Offset_0x013BAA
                bne.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
                _move.b #$5D, 0(A1)                                 ; $0000
                move.l  #CPz_Boss_Mappings, Obj_Map(A1) ; Offset_0x02A338, $0004
...
Offset_0x02967A:
                ...
                beq.w   Offset_0x029888
                move.b  #$0E, Obj_Routine(A1)                            ; $0024
                bra.w   Offset_0x029888
Offset_0x0296E0:
...
Offset_0x0297E4:
                ...
                lea     (CPz_Boss_Animate_Data).l, A1            ; Offset_0x02A298
                jsr     (AnimateSprite).l                        ; Offset_0x01212E
                jmp     (DisplaySprite).l                        ; Offset_0x0120DE
;-------------------------------------------------------------------------------                
Offset_0x029800:
...
Offset_0x029828:
                ...
                bra.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
;-------------------------------------------------------------------------------                
Offset_0x02983C:
...
Offset_0x0298D8:
                ...
                bra.w   Jmp_1B_To_DisplaySprite                ; Offset_0x02A678
;-------------------------------------------------------------------------------                
Offset_0x029904:
                btst    #$07, Obj_Status(A0)                             ; $0022
                bne.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
...
Offset_0x0299BA:
                ...
                bge.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
                rts
Offset_0x0299E0:
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                move.w  Obj_X(A1), Obj_X(A0)                      ; $0008, $0008
...
Offset_0x029AE6:
                ...
                bsr.w   Offset_0x029D58
                bsr.w   Offset_0x029C7C
...
Offset_0x029E2E:
                ...
                beq.w   Jmp_1E_To_DeleteObject                 ; Offset_0x02A67E
                move.l  D0, A1
...
;-------------------------------------------------------------------------------                
Offset_0x029F54:
                bsr.w   Jmp_06_To_ObjectFall                   ; Offset_0x02A69C
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                tst.w   D1
...
Offset_0x029FFC:
                bsr.w   Jmp_17_To_SpeedToPos                   ; Offset_0x02A6A2
                lea     (CPz_Boss_Animate_Data).l, A1            ; Offset_0x02A298
                jsr     (AnimateSprite).l                        ; Offset_0x01212E
                jmp     (DisplaySprite).l                        ; Offset_0x0120DE
;-------------------------------------------------------------------------------                
...
Offset_0x02A1F2:
                ...
                bne.w   Jmp_1B_To_DisplaySprite                ; Offset_0x02A678
