...
Offset_0x00914A:
                bsr.w   Jmp_00_To_SpeedToPos                   ; Offset_0x0096A0
                cmpi.w  #$FFE8, Obj_X(A0)                                ; $0008
                blt.w   Jmp_00_To_DeleteObject                 ; Offset_0x00969A
                cmpi.w  #$0118, Obj_X(A0)                                ; $0008
                bgt.w   Jmp_00_To_DeleteObject                 ; Offset_0x00969A
                cmpi.w  #$0100, Obj_Y(A0)                                ; $000C
                bgt.w   Jmp_00_To_DeleteObject                 ; Offset_0x00969A
                bra.w   Jmp_00_To_DisplaySprite                ; Offset_0x009694
;-------------------------------------------------------------------------------                  
Offset_0x009170:
...
Offset_0x0091A2:
                ...
                blt.w   Jmp_00_To_DisplaySprite                ; Offset_0x009694
                bsr.w   Offset_0x0092A2
...
Offset_0x00923A:
                ...
                st      ($FFFF9B23).w
                bra.w   Jmp_00_To_DeleteObject                 ; Offset_0x00969A
Offset_0x00924A:
                rts
;-------------------------------------------------------------------------------                
