...
Offset_0x03032A:
                ...
                bsr.w   Offset_0x0304F4
                move.l  A1, Obj_Control_Var_08(A0)                       ; $0034
;-------------------------------------------------------------------------------                  
Offset_0x030362:
                bsr.w   Offset_0x0303A2
                bsr.w   Offset_0x030386
                bsr.w   Offset_0x030436
                lea     (SS_Rings_AnimateData).l, A1             ; Offset_0x03073A
                bsr.w   Offset_0x0305E8
                tst.b   Obj_Flags(A0)                                    ; $0001
                bmi.w   Jmp_25_To_DisplaySprite                ; Offset_0x030A10
                rts    
;-------------------------------------------------------------------------------  
; Offset_0x030382:
                bra.w   Jmp_25_To_DisplaySprite                ; Offset_0x030A10
;-------------------------------------------------------------------------------                  
Offset_0x030386:
                moveq   #$0C, D0
...
Offset_0x0303C8:
                ...
                move.l  (A7)+, D0
                bra.w   Jmp_26_To_DeleteObject                 ; Offset_0x030A16       
;-------------------------------------------------------------------------------
Offset_0x0303D6:
...
Offset_0x03048A:
                ...
                bsr.w   Jmp_0C_To_CalcSine                     ; Offset_0x030A22
                muls.w  D4, D1
                muls.w  D5, D0
                asr.l   #$08, D0
                asr.l   #$08, D1
...
Offset_0x03058A:
                ...
                bne.w   Jmp_26_To_DeleteObject                 ; Offset_0x030A16
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
