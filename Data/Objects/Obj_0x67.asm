...
; Offset_0x021B5C:
                ...
                beq.w   Jmp_05_To_MarkObjGone_3                ; Offset_0x021F8C
                lea     (Teleport_Animate_Data).l, A1            ; Offset_0x021F2E
                bsr.w   Jmp_04_To_AnimateSprite                ; Offset_0x021F86
                bra.w   Jmp_0D_To_DisplaySprite                ; Offset_0x021F80
;-------------------------------------------------------------------------------
Offset_0x021B84:
...
Offset_0x021D10:
                ...
                andi.w  #$000F, D0
                add.w   D0, D0
                lea     (Teleport_From_To_Data).l, A2            ; Offset_0x021DF2
                adda.w  $00(A2, D0), A2
                move.w  (A2)+, D0
                subq.w  #$04, D0
