...
Offset_0x02253C:
                ...
                bne.w   Offset_0x0225D0
                bsr.w   Jmp_0A_To_SingleObjectLoad_2           ; Offset_0x022754
...
Offset_0x0225D0:
                bsr.w   Jmp_19_To_ModifySpriteAttr_2P          ; Offset_0x02275A
                move.b  Obj_Subtype(A0), Obj_Control_Var_0C(A0)   ; $0028, $0038
                bra.w   Offset_0x0226A2
Offset_0x0225DE:
...
Offset_0x02263E:
                ...
                move.w  D2, D3
                addq.w  #$01, D3
                bsr.w   Jmp_0A_To_SolidObject                  ; Offset_0x022760
Offset_0x02265E:
                move.w  Obj_Control_Var_06(A0), D0                       ; $0032
                bra.w   Jmp_02_To_MarkObjGone_2                ; Offset_0x022766
Offset_0x022666:
                move.w  Obj_X(A0), -(A7)                                 ; $0008
                jsr     (SpeedToPos).l                           ; Offset_0x011F96
                subq.w  #$01, Obj_Control_Var_08(A0)                     ; $0034
