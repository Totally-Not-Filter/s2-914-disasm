...
Offset_0x022FC6:
                ...
                bsr.w   Jmp_1D_To_ModifySpriteAttr_2P          ; Offset_0x023300
                ...
                lsr.w   #$03, D0
                andi.w  #$000E, D0
                lea     (Parallelogram_Elevator_Data).l, A1      ; Offset_0x0230EE
                move.w  $00(A1, D0), D0
                lea     $00(A1, D0), A1
                move.l  A1, Obj_Control_Var_10(A0)                       ; $003C
                bsr.w   Offset_0x0230C0
...
Offset_0x02302C:
                ...
                lea     (Parallelogram_Elevator_Solid_Data).l, A2 ; Offset_0x02317A
                bsr.w   Offset_0x023306
