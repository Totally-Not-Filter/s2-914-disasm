...
Offset_0x02391C:
                move.w  #$0280, D0
                bra.w   Jmp_00_To_DisplaySprite_Param          ; Offset_0x023AFC
;-------------------------------------------------------------------------------  
Offset_0x023924:
...
Offset_0x02392A:
                ...
                bsr.w   Jmp_1F_To_ModifySpriteAttr_2P          ; Offset_0x023B20
...
Offset_0x02399A:
                ...
                bsr.w   Jmp_0C_To_SingleObjectLoad_2           ; Offset_0x023B1A
...
Offset_0x023A06:
                ...
                bsr.w   Jmp_07_To_CalcSine                     ; Offset_0x023B26
...
Offset_0x023A7A:
                ...
                bra.w   Jmp_10_To_DisplaySprite                ; Offset_0x023B02
Offset_0x023A84:
                move.w  Obj_Control_Var_04(A0), D0                       ; $0030
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x023A9C
                bra.w   Jmp_10_To_DisplaySprite                ; Offset_0x023B02
Offset_0x023A9C:
                move.l  Obj_Control_Var_10(A0), A1                       ; $003C
                bsr.w   Jmp_01_To_DeleteObject_A1              ; Offset_0x023B14
                bra.w   Jmp_12_To_DeleteObject                 ; Offset_0x023B08   
;-------------------------------------------------------------------------------  
Offset_0x023AA8:
                moveq   #$00, D1
                ...
                bsr.w   Jmp_0F_To_SolidObject                  ; Offset_0x023B2C
                bra.w   Jmp_14_To_MarkObjGone                  ; Offset_0x023B0E        
;-------------------------------------------------------------------------------
