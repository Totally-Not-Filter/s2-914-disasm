...
Offset_0x024130:
                bsr.w   Jmp_22_To_ModifySpriteAttr_2P          ; Offset_0x0242C0
                moveq   #$00, D1
...
;-------------------------------------------------------------------------------    
Offset_0x024144:
                bsr.w   Jmp_0E_To_SingleObjectLoad_2           ; Offset_0x0242BA
...
Offset_0x0241CA:
                ...
                bra.w   Jmp_11_To_DisplaySprite                ; Offset_0x0242B4
Offset_0x0241D6:
...
Offset_0x024200:
                ...
                jsr     (DeleteObject_A1).l                      ; Offset_0x0120D2
Offset_0x02420E:
                lea     ($FFFFFC00).w, A2
                moveq   #$00, D0
...
Offset_0x024268:
                ...
                move.w  #$0008, D3
                move.w  (A7)+, D4
                bsr.w   Jmp_01_To_Platform_Object              ; Offset_0x0242C6
                rts
Offset_0x02427A:
                move.l  Obj_Control_Var_10(A0), A1                       ; $003C
                move.w  Obj_X(A0), D0                                    ; $0008
