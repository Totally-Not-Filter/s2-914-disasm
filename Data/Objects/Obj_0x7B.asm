...
; Offset_0x0242CC:
                ...
                bra.w   Jmp_12_To_DisplaySprite                ; Offset_0x0244F4
Offset_0x0242E4:
                move.w  Obj_X(A0), D0                                    ; $0008
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Jmp_13_To_DeleteObject                 ; Offset_0x0244FA
                bra.w   Jmp_12_To_DisplaySprite                ; Offset_0x0244F4
;-------------------------------------------------------------------------------  
Offset_0x0242FC:
...
Offset_0x024304:
                ...
                bsr.w   Jmp_23_To_ModifySpriteAttr_2P          ; Offset_0x024506        
;-------------------------------------------------------------------------------
Offset_0x02433A:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   Jmp_03_To_SolidObject_2_A1             ; Offset_0x02450C
                btst    #$03, Obj_Status(A0)                             ; $0022
                beq.s   Offset_0x02436C
                bsr.w   Offset_0x0243F4
Offset_0x02436C:
                movem.l (A7)+, D1-D4
...
Offset_0x0243E8:
                lea     (Spring_Tube_Animate_Data).l, A1         ; Offset_0x02449A
                bra.w   Jmp_05_To_AnimateSprite                ; Offset_0x024500                                   
                rts
Offset_0x0243F4:
