...
Offset_0x024B84:
                move.w  #$0280, D0
                bra.w   Jmp_01_To_DisplaySprite_Param          ; Offset_0x024DCC      
;-------------------------------------------------------------------------------
Offset_0x024B8C:
...
Offset_0x024B92:
                ...
                bsr.w   Jmp_26_To_ModifySpriteAttr_2P          ; Offset_0x024DEA
...
Offset_0x024BFE:
                ...
                bsr.w   Jmp_0F_To_SingleObjectLoad_2           ; Offset_0x024DE4
...
Offset_0x024C6A:
                ...
                move.w  #$00E7, D0
                jsr     (Play_Music_Ex).l                        ; Offset_0x001918
...
Offset_0x024D20:
                ...
                bsr.w   Jmp_13_To_SolidObject                  ; Offset_0x024DF6
                tst.w   (Two_Player_Flag).w                          ; $FFFFFFD8
                beq.s   Offset_0x024D32
                bra.w   Jmp_13_To_DisplaySprite                ; Offset_0x024DD2
Offset_0x024D32:
                move.w  Obj_Control_Var_04(A0), D0                       ; $0030
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x024D4A
                bra.w   Jmp_13_To_DisplaySprite                ; Offset_0x024DD2
Offset_0x024D4A:
                move.l  Obj_Control_Var_10(A0), A1                       ; $003C
                bsr.w   Jmp_02_To_DeleteObject_A1              ; Offset_0x024DDE
                bra.w   Jmp_14_To_DeleteObject                 ; Offset_0x024DD8
Offset_0x024D56:
                tst.b   Obj_Control_Var_0A(A0)                           ; $0036
                ...
                moveq   #$00, D1
                move.b  Obj_Angle(A0), D0                                ; $0026
                bsr.w   Jmp_08_To_CalcSine                     ; Offset_0x024DF0
