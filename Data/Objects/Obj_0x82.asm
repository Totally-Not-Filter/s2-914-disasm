...
Offset_0x024E16:
                ...
                bsr.w   Jmp_27_To_ModifySpriteAttr_2P          ; Offset_0x02504A
...
Offset_0x024E7E:
                ...
                move.w  D2, D3
                addq.w  #$01, D3
                bsr.w   Jmp_14_To_SolidObject                  ; Offset_0x025056
                swap    D6
                move.b  D6, Obj_Control_Var_13(A0)                       ; $003F
                bsr.w   Offset_0x024F9E
Offset_0x024EBC:
                move.w  Obj_Control_Var_08(A0), D0                       ; $0034
                bra.w   Jmp_06_To_MarkObjGone_2                ; Offset_0x02505C     
;-------------------------------------------------------------------------------
Offset_0x024EC4:
...
;-------------------------------------------------------------------------------
Offset_0x024EFE:
                bsr.w   Jmp_0E_To_SpeedToPos                   ; Offset_0x025062
                addi.w  #$0008, Obj_Speed_Y(A0)                          ; $0012
                bsr.w   Jmp_01_To_ObjHitFloor                  ; Offset_0x025044
                tst.w   D1
                bpl.w   Offset_0x024F20
                addq.w  #$01, D1
...
Offset_0x024F22:
                ...
                bsr.w   Jmp_00_To_Object_HitCeiling            ; Offset_0x025050
                tst.w   D1
                bpl.w   Offset_0x024F42
