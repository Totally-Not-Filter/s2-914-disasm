...
Offset_0x025080:
                move.w  #$0280, D0
                bra.w   Jmp_02_To_DisplaySprite_Param          ; Offset_0x0252E4
;-------------------------------------------------------------------------------
Offset_0x025088:
...
Offset_0x02508E:
                ...
                bsr.w   Jmp_28_To_ModifySpriteAttr_2P          ; Offset_0x025302
                ...
                bsr.w   Jmp_10_To_SingleObjectLoad_2           ; Offset_0x0252FC
...
Offset_0x02518C:
                ...
                bsr.w   Jmp_09_To_CalcSine                     ; Offset_0x025308
                swap    D0
                swap    D1
                asr.l   #$04, D0
                asr.l   #$04, D1
                ...
                move.w  #$0009, D3
                move.w  (A7)+, D4
                bsr.w   Jmp_02_To_Platform_Object              ; Offset_0x02530E
                tst.w   (Two_Player_Flag).w                          ; $FFFFFFD8
                beq.s   Offset_0x025276
                bra.w   Jmp_14_To_DisplaySprite                ; Offset_0x0252EA
Offset_0x025276:
                move.w  Obj_Control_Var_04(A0), D0                       ; $0030
                andi.w  #$FF80, D0
                sub.w   ($FFFFF7DA).w, D0
                cmpi.w  #$0280, D0
                bhi.w   Offset_0x02528E
                bra.w   Jmp_14_To_DisplaySprite                ; Offset_0x0252EA
Offset_0x02528E:
                move.l  Obj_Control_Var_08(A0), A1                       ; $0034
                bsr.w   Jmp_03_To_DeleteObject_A1              ; Offset_0x0252F6
                bra.w   Jmp_15_To_DeleteObject                 ; Offset_0x0252F0
Offset_0x02529A:
                movem.l D4/D5, -(A7)
                swap    D4
                swap    D5
...
Offset_0x0252BA:
                ...
                move.w  Obj_Control_Var_04(A0), D0                       ; $0030
                bra.w   Jmp_07_To_MarkObjGone_2                ; Offset_0x025314        
;===============================================================================   
; Objeto 0x83 - Três plataformas girando na Neo Green Hill
; <<<-        
;===============================================================================