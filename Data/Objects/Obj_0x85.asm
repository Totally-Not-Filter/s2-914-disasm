...
; Offset_0x0256D4:
                ...
                bra.w   Jmp_03_To_DisplaySprite_Param          ; Offset_0x025C1C
Offset_0x0256F0:
                move.w  Obj_X(A0), D1                                    ; $0008
                andi.w  #$FF80, D1
                sub.w   ($FFFFF7DA).w, D1
                cmpi.w  #$0280, D1
                bhi.w   Offset_0x025708
                bra.w   Jmp_03_To_DisplaySprite_Param          ; Offset_0x025C1C
Offset_0x025708:
                lea     ($FFFFFC00).w, A2
                moveq   #$00, D0
                ...
                bclr    #$07, $02(A2, D0)
Offset_0x02571A:
                bra.w   Jmp_16_To_DeleteObject                 ; Offset_0x025C22       
;-------------------------------------------------------------------------------
Offset_0x02571E:
...
Offset_0x02574A:
                bsr.w   Jmp_2A_To_ModifySpriteAttr_2P          ; Offset_0x025C28
...
Offset_0x025880:
                ...
                bsr.w   Jmp_04_To_SolidObject_2_A1             ; Offset_0x025C2E
