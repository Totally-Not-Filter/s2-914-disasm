...
; Offset_0x025C34:
                ...
                bra.w   Jmp_19_To_MarkObjGone                  ; Offset_0x025FF0
;-------------------------------------------------------------------------------
Offset_0x025C46:
...
Offset_0x025C4C:
                ...
                bsr.w   Jmp_2B_To_ModifySpriteAttr_2P          ; Offset_0x025FFC
                ...
                bra.w   Offset_0x025E06     
;-------------------------------------------------------------------------------
Offset_0x025C88:
                tst.w   (Debug_Mode_Flag_Index).w                    ; $FFFFFE08
                bne.s   Offset_0x025CFC
                lea     (Offset_0x025EB2).l, A2
                move.b  Obj_Map_Id(A0), D0                               ; $001A
                beq.s   Offset_0x025CAA
                lea     (Offset_0x025ED6).l, A2
                subq.b  #$01, D0
                beq.s   Offset_0x025CAA
                lea     (Offset_0x025EFA).l, A2
Offset_0x025CAA:
                move.w  #$0023, D1
                move.w  #$0006, D2
                move.w  Obj_X(A0), D4                                    ; $0008
                bsr.w   Jmp_01_To_SolidObject_3                ; Offset_0x02600E
                ...
                bsr.w   Offset_0x025D84
                subq.w  #$01, A3
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                moveq   #$03, D6
                bsr.w   Offset_0x025D84
Offset_0x025CF2:
                lea     (Flippers_Animate_Data).l, A1            ; Offset_0x025F1E
                bra.w   Jmp_06_To_AnimateSprite                ; Offset_0x025FF6
Offset_0x025CFC:
                rts
Offset_0x025CFE:
                move.b  (A3), D0
...
Offset_0x025DAE:
                ...
                asr.w   #$02, D0
                addi.w  #$0040, D0
                bsr.w   Jmp_0A_To_CalcSine                     ; Offset_0x026002
                muls.w  D2, D0
                muls.w  D2, D1
                asr.l   #$08, D0
                asr.l   #$08, D1
...
Offset_0x025E06:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   Jmp_05_To_SolidObject_2_A1             ; Offset_0x026008
