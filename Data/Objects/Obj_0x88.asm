...
; Offset_0x02FDDE:
                ...
                lea     (Miles_Tail_In_SS_AnimateData).l, A1     ; Offset_0x0300EC
                bsr.w   Jmp_18_To_AnimateSprite                ; Offset_0x030212
                bsr.w   Offset_0x02FE28
                bra.w   Jmp_24_To_DisplaySprite                ; Offset_0x03020C
Offset_0x02FE1A:
                rts      
;-------------------------------------------------------------------------------  
...
Offset_0x02FE4A:
                ...
                addi.w  #$0044, D0
                add.w   D0, D0
                lea     (Miles_Tail_In_SS_Dyn_Script).l, A2      ; Offset_0x02F94E
                adda.w  $00(A2, D0), A2
                move.w  #$6EA0, D2
                moveq   #$00, D1
                move.w  (A2)+, D1
