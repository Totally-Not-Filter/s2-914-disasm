...
Offset_0x0312B8:
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
Offset_0x0312BC:
                lea     (Chop_Chop_Animate_Data).l, A1           ; Offset_0x031342
