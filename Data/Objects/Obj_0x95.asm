...
Offset_0x031564:
                ...
                bsr.w   Jmp_3A_To_ModifySpriteAttr_2P          ; Offset_0x037638
...
Offset_0x03165A:
                ...
                lea     (Sol_Animate_Data).l, A1                 ; Offset_0x031720
...
Offset_0x031672:
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                lea     (Sol_Animate_Data_01).l, A1              ; Offset_0x03172E
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                andi.b  #$03, Obj_Map_Id(A0)                             ; $001A
                bra.w   Jmp_28_To_MarkObjGone                  ; Offset_0x037608    
;------------------------------------------------------------------------------- 
Offset_0x03168A:
                ...
                bne.w   Jmp_27_To_DeleteObject                 ; Offset_0x0375FC
...
Offset_0x031706:
                ...
                bpl.w   Jmp_27_To_DeleteObject                 ; Offset_0x0375FC
                lea     (Sol_Animate_Data_01).l, A1              ; Offset_0x03172E
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6    
;-------------------------------------------------------------------------------      
