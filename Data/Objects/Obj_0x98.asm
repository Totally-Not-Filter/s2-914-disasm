...
;-------------------------------------------------------------------------------
Offset_0x031B48:
                bra.w   Object_Settings                        ; Offset_0x030A30
Offset_0x031B4C:
...
Nebula_Weapon:                                                 ; Offset_0x031B5E
                ...
                bra.w   Jmp_0B_To_ObjectFall                   ; Offset_0x037650   
;-------------------------------------------------------------------------------
Turtloid_Weapon:                                               ; Offset_0x031B68
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                lea     (Turtloid_Weapon_Animate_Data).l, A1     ; Offset_0x031F9E                             
...
Clucker_Weapon:                                                ; Offset_0x031B82
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                lea     (Clucker_Weapon_Animate_Data).l, A1      ; Offset_0x033986                                
                bra.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620    
;-------------------------------------------------------------------------------                
Spiny_Weapon:                                                  ; Offset_0x031B90
                addi.w  #$0020, Obj_Speed_Y(A0)                          ; $0012
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                lea     (Spiny_Weapon_Animate_Data).l, A1        ; Offset_0x0330AC
                bra.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
;-------------------------------------------------------------------------------                
Cannon_Weapon:                                                 ; Offset_0x031BA4
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                lea     (Cannon_Weapon_Animate_Data).l, A1       ; Offset_0x035988                           
                bra.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620  
;-------------------------------------------------------------------------------  
