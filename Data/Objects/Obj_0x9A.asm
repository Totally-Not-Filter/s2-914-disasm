...
Offset_0x031D96:
                ...
                bsr.w   Load_Turtloid_Sub_Obj_0x9B             ; Offset_0x031E98
                lea     (Turtloid_Animate_Data).l, A1            ; Offset_0x031FA4
                move.l  A1, Obj_Control_Var_02(A0)                       ; $002E
                bra.w   Load_Enemy_Boost_Sub_Obj_0x9C          ; Offset_0x031F0C
Offset_0x031DB2:
                moveq   #$00, D0
                move.b  Obj_Routine_2(A0), D0                            ; $0025
                move.w  Offset_0x031DC8(PC, D0), D1
                jsr     Offset_0x031DC8(PC, D1)
                bsr.w   Offset_0x031DD0
                bra.w   Offset_0x030C32      
Offset_0x031DC8:
...
Offset_0x031DD0:
                ...
                move.w  #$000E, D3
                move.w  (A7)+, D4
                bra.w   Jmp_04_To_Platform_Object              ; Offset_0x037644
Offset_0x031DEE:
                bsr.w   Offset_0x030B18
                tst.w   D0
                bmi.w   Return_to_sub_routine                  ; Offset_0x031E96
                cmpi.w  #$0080, D2
                bcc.w   Return_to_sub_routine                  ; Offset_0x031E96
