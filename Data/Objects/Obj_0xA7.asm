...
Offset_0x0331C6:
                ...
                lea     (Load_Grabber_Sub_Obj_0xA9).l, A2        ; Offset_0x0335BE
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                lea     (Load_Grabber_Sub_Obj_0xA8).l, A2        ; Offset_0x0335C2
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                lea     (Load_Grabber_Sub_Obj_0xAA).l, A2        ; Offset_0x0335C6
                bra.w   Load_Sub_Obj                           ; Offset_0x030BE4  
;-------------------------------------------------------------------------------
Offset_0x0331F4:
                moveq   #$00, D0
                ...
                bra.w   Obj_0xA7_Sub_02                        ; Offset_0x033560    
;-------------------------------------------------------------------------------                       
Offset_0x03322E:
...
Offset_0x0332B4:
                lea     (Grabber_Animate_Data).l, A1             ; Offset_0x0335F2
...
;-------------------------------------------------------------------------------
Offset_0x033326:
                bsr.w   Obj_0xA7_Sub_01                        ; Offset_0x033518
                bsr.w   Obj_0xA7_Sub                           ; Offset_0x03349A
                subq.b  #$01, Obj_Control_Var_00(A0)                     ; $002C
...
Offset_0x033340:
                bsr.w   Obj_0xA7_Sub_01                        ; Offset_0x033518
                bra.w   Obj_0xA7_Sub                           ; Offset_0x03349A  
                rts   
;-------------------------------------------------------------------------------
Offset_0x03334A:
                bra.w   Obj_0xA7_Sub_01                        ; Offset_0x033518
;===============================================================================   
; Objeto 0xA7 - Inimigo Grabber (aranha) na Chemical Plant
; <<<-        
;===============================================================================