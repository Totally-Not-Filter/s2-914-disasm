...
Offset_0x033880:
                ...
                lea     (Clucker_Animate_Data).l, A1             ; Offset_0x033968
...
;-------------------------------------------------------------------------------                 
Offset_0x0338B0:
                lea     (Clucker_Animate_Data_01).l, A1          ; Offset_0x033974
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                bra.w   Jmp_28_To_MarkObjGone                  ; Offset_0x037608
;-------------------------------------------------------------------------------                 
Offset_0x0338BE:
...
Offset_0x0338CC:
                ...
                clr.w   Obj_Map(A1)                                      ; $0004
                move.b  #$0B, (A1)
                bsr.w   Load_Clucker_Weapon                    ; Offset_0x033904
                bra.w   Jmp_28_To_MarkObjGone                  ; Offset_0x037608
;-------------------------------------------------------------------------------                 
Offset_0x0338E6:
                lea     (Clucker_Animate_Data_02).l, A1          ; Offset_0x033980
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                bra.w   Jmp_28_To_MarkObjGone                  ; Offset_0x037608
;-------------------------------------------------------------------------------                 
Offset_0x0338F4:
