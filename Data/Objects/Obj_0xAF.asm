...
;-------------------------------------------------------------------------------     
Offset_0x033B3A:
                bsr.w   Object_Settings                        ; Offset_0x030A30
                move.b  #$1B, Obj_Height_2(A0)                           ; $0016
                move.b  #$10, Obj_Width_2(A0)                            ; $0017
                move.b  #$00, Obj_Col_Flags(A0)                          ; $0020
                move.b  #$08, Obj_Col_Prop(A0)                           ; $0021
                lea     (Load_Metal_Sonic_Sub_Obj_0xAF).l, A2    ; Offset_0x034130
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                move.b  #$0C, Obj_Routine(A1)                            ; $0024
                lea     (Load_Metal_Sonic_Sub_Obj_0xAF_1).l, A2  ; Offset_0x034134
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                move.b  #$12, Obj_Routine(A1)                            ; $0024
                lea     (Load_Metal_Sonic_Sub_Obj_0xAF_2).l, A2  ; Offset_0x034138
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
...
Offset_0x033B88:
                ...
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6
Offset_0x033B96:
...
Offset_0x033BB0:
                ...
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                moveq   #$00, D0
                moveq   #$00, D1
                move.w  Obj_Control_Var_12(A0), A1                       ; $003E
                bsr.w   Offset_0x030C0A
                bsr.w   Offset_0x0340B8
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6
Offset_0x033BD2:
                ...
                bra.w   Offset_0x033D62                 
;-------------------------------------------------------------------------------
Offset_0x033BEC:
                bsr.w   Offset_0x03401C
                bsr.w   Offset_0x03408A
                subq.b  #$01, Obj_Timer(A0)                              ; $002A
                beq.s   Offset_0x033C16
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                add.w   D1, Obj_Y(A0)                                    ; $000C
                lea     (Metal_Sonic_Animate_Data).l, A1         ; Offset_0x034150
                bsr.w   Animate_Sprite_2                       ; Offset_0x030CEC
                bsr.w   Offset_0x0340B8
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6
Offset_0x033C16:
                addq.b  #$02, Obj_Routine(A0)                            ; $0024
...
Offset_0x033DE6:
                ...
                bsr.w   Offset_0x0340E0
                lea     (Metal_Sonic_Animate_Data).l, A1         ; Offset_0x034150
                bra.w   Animate_Sprite_2                       ; Offset_0x030CEC
Offset_0x033DFA:
                addq.b  #$02, Obj_Routine_2(A0)                          ; $0025
...
Offset_0x033E72:
                subq.b  #$01, Obj_Timer(A0)                              ; $002A
                bmi.w   Offset_0x033DFA
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                tst.w   D1
                bpl.s   Offset_0x033E88
                bsr.w   Offset_0x033E98
Offset_0x033E88:
...
Offset_0x033EC2:
                ...
                bsr.w   Offset_0x0340F0
Offset_0x033EDE:
                jsr     (ObjHitFloor).l                          ; Offset_0x019B74
                tst.w   D1
                bpl.s   Offset_0x033EEC
                bsr.w   Offset_0x033EFC
Offset_0x033EEC:
                addi.w  #$0038, Obj_Speed_Y(A0)                          ; $0012
                lea     (Metal_Sonic_Animate_Data).l, A1         ; Offset_0x034150
                bra.w   Animate_Sprite_2                       ; Offset_0x030CEC
...
Offset_0x033F0A:
                ...
                bsr.w   Jmp_00_To_Boss_Defeated                ; Offset_0x03763E
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6
Offset_0x033F1C:
                move.w  #$1000, (Sonic_Level_Limits_Max_X).w         ; $FFFFEECA
                addq.b  #$02, ($FFFFEEDF).w
                bra.w   Jmp_27_To_DeleteObject                 ; Offset_0x0375FC     
;-------------------------------------------------------------------------------  
Offset_0x033F2A:
                bsr.w   Object_Settings                        ; Offset_0x030A30
...
Offset_0x033F3C:
                ...
                bsr.w   Offset_0x030C50
                lea     (Metal_Sonic_Animate_Data_1).l, A1       ; Offset_0x03419E
                bsr.w   Animate_Sprite_2                       ; Offset_0x030CEC
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6 
;-------------------------------------------------------------------------------  
Offset_0x033F52:
...
;-------------------------------------------------------------------------------  
Offset_0x033FAC:
                lea     (Metal_Sonic_Animate_Data_2).l, A1       ; Offset_0x0341B0
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6    
;-------------------------------------------------------------------------------  
Offset_0x033FBA:
                move.w  Obj_Control_Var_00(A0), A1                       ; $002C
...
Offset_0x03400A:
                lea     (Metal_Sonic_Animate_Data_2).l, A1       ; Offset_0x0341B0
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
                bsr.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6
                bra.w   Jmp_28_To_MarkObjGone                  ; Offset_0x037608
Offset_0x03401C:
...
Offset_0x03404C:
                ...
                bne.s   Offset_0x03405C
                clr.w   ($FFFFFB22).w
                bsr.w   Offset_0x034092
Offset_0x03405C:
                rts
Offset_0x03405E:
                moveq   #$64, D0
                bsr.w   AddPoints                              ; Offset_0x0394D0
                move.w  #$00EF, Obj_Control_Var_06(A0)                   ; $0032
                move.b  #$0A, Obj_Routine(A0)                            ; $0024
                clr.b   Obj_Col_Flags(A0)                                ; $0020
                bset    #$02, Obj_Status(A0)                             ; $0022
                move.w  Obj_Control_Var_10(A0), A1                       ; $003C
                bsr.w   Jmp_04_To_DeleteObject_A1              ; Offset_0x03760E
                move.w  Obj_Control_Var_12(A0), A1                       ; $003E
                bra.w   Jmp_04_To_DeleteObject_A1              ; Offset_0x03760E
Offset_0x03408A:
                tst.b   Obj_Col_Flags(A0)                                ; $0020
                beq.w   Return_to_sub_routine                  ; Offset_0x031E96
Offset_0x034092:
...
Offset_0x0340F0:
                move.b  #$4A, D2
                moveq   #$07, D6
                lea     (Offset_0x034100).l, A2
                bra.w   Enemy_Weapon                           ; Offset_0x030C98   
;-------------------------------------------------------------------------------    
Offset_0x034100:
