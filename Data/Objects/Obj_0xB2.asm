...
;===============================================================================
Offset_0x034C9C:
                bsr.w   Tornado_Load_Miles                     ; Offset_0x035076
                moveq   #$00, D0
...
Offset_0x034CCC:
                ...
                bsr.w   Offset_0x034EC8
                move.b  Obj_Status(A0), Obj_Control_Var_02(A0)    ; $0022, $002E
                move.w  #$001B, D1
                move.w  #$0008, D2
                move.w  #$0009, D3
                move.w  (A7)+, D4
                bsr.w   Jmp_19_To_SolidObject                  ; Offset_0x03764A
                bsr.w   Offset_0x034F58
                ...
                move.w  D0, (Sonic_Level_Limits_Max_X).w             ; $FFFFEECA
Offset_0x034D46:
                lea     (Tornado_Animate_Data).l, A1             ; Offset_0x0350C2
...
Offset_0x034D88:
                ...
                bsr.w   Offset_0x030C20
                move.w  #$001B, D1
                move.w  #$0008, D2
                move.w  #$0009, D3
                move.w  (A7)+, D4
                bsr.w   Jmp_19_To_SolidObject                  ; Offset_0x03764A
                bra.w   Offset_0x03500A
Offset_0x034DB0:
                addq.b  #$02, Obj_Routine_2(A0)                          ; $0025
...
Offset_0x034DC8:
                ...
                bsr.w   Tornado_Load_Smoke                     ; Offset_0x035052
Offset_0x034DD8:
                bra.w   Offset_0x034EAA
;-------------------------------------------------------------------------------                
Offset_0x034DDC:
                moveq   #$00, D0
                move.b  Obj_Routine_2(A0), D0                            ; $0025
...
Offset_0x034E72:
                bsr.w   Offset_0x034EAA
                bsr.w   Offset_0x03500A
                lea     (Tornado_Animate_Data).l, A1             ; Offset_0x0350C2
                bsr.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620
...
Offset_0x034EAA:
                ...
                move.w  #$0009, D3
                move.w  (A7)+, D4
                bra.w   Jmp_19_To_SolidObject                  ; Offset_0x03764A
Offset_0x034EC8:
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                btst    #$03, Obj_Status(A1)                             ; $0022
                beq.s   Offset_0x034EE4
                bsr.w   Offset_0x034F14
                bsr.w   Offset_0x03502A
                bsr.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
                bra.w   Offset_0x030C20
Offset_0x034EE4:
                tst.b   Obj_Control_Var_02(A0)                           ; $002E
                beq.s   Offset_0x034EF2
                bsr.w   Offset_0x030B18
...
Tornado_Load_Smoke:                                            ; Offset_0x035052
                bsr.w   Jmp_16_To_SingleObjectLoad_2           ; Offset_0x03761A
                bne.s   Offset_0x035074
                _move.b #$C4, 0(A1)                                 ; $0000
...
Offset_0x035094:
                ...
                bra.w   Jmp_00_Load_Miles_Dynamic_PLC_D0       ; Offset_0x037632                               
;------------------------------------------------------------------------------- 
Offset_0x0350A0:
