...
Offset_0x036388:
                ...
                lea     (Load_SFz_Boss_Sub_Obj_0xC5).l, A2       ; Offset_0x0366AC
                ...
                addi.w  #$0048, Obj_Y(A1)                                ; $000C
                lea     (Load_SFz_Boss_Sub_Obj_0xC5_3).l, A2     ; Offset_0x0366B8
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                rts       
;------------------------------------------------------------------------------- 
Offset_0x0363CA:
...
;------------------------------------------------------------------------------- 
Offset_0x0363D8:
                lea     (SFz_Boss_Animate_Data).l, A1            ; Offset_0x0366EE
                bra.w   Jmp_1A_To_AnimateSprite                ; Offset_0x037620   
;------------------------------------------------------------------------------- 
Offset_0x0363E2:
                addq.b  #$02, Obj_Routine_2(A0)                          ; $0025
                move.b  #$01, Obj_Ani_Number(A0)                         ; $001C
                move.w  #$0090, Obj_Timer(A0)                            ; $002A
                lea     (Load_SFz_Boss_Sub_Obj_0xC5_2).l, A2     ; Offset_0x0366B4
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
                move.l  A1, A3
                lea     (Load_SFz_Boss_Sub_Obj_0xC5_1).l, A2     ; Offset_0x0366B0
                bsr.w   Load_Sub_Obj                           ; Offset_0x030BE4
...
Offset_0x03645E:
                ...
                bne.w   Return_to_sub_routine                  ; Offset_0x031E96
                bra.w   Jmp_26_To_DisplaySprite                ; Offset_0x0375F6   
;------------------------------------------------------------------------------- 
Offset_0x036482:
                moveq   #$00, D0
...
Offset_0x03653A:
                ...
                bra.w   Jmp_1A_To_SpeedToPos                   ; Offset_0x037656
Offset_0x036544:
                addq.b  #$02, Obj_Routine_2(A0)                          ; $0025
