...
Offset_0x026656:
                ...
                bsr.w   Jmp_30_To_ModifySpriteAttr_2P          ; Offset_0x026F2A
...
Offset_0x02667E:
                ...
                moveq   #$03, D6
                movem.l D1-D4, -(A7)
                bsr.w   Offset_0x0266C0
                movem.l (A7)+, D1-D4
                lea     Obj_Control_Var_08(A0), A2                       ; $0034
                lea     (Obj_Memory_Address+$0040).w, A1             ; $FFFFB040
                moveq   #$04, D6
                bsr.w   Offset_0x0266C0
                lea     (Slot_Machine_Starter_Animate_Data).l, A1 ; Offset_0x02679C
                bsr.w   Jmp_07_To_AnimateSprite                ; Offset_0x026F24
                bra.w   Jmp_1B_To_MarkObjGone                  ; Offset_0x026F1E
Offset_0x0266C0:
                move.w  (A2), D0
...
;-------------------------------------------------------------------------------
Offset_0x0266D0:
                bsr.w   Jmp_06_To_SolidObject_2_A1             ; Offset_0x026F30
                tst.w   D4
...
Offset_0x026760:
                ...
                bsr.w   Jmp_07_To_SingleObjectLoad             ; Offset_0x026F18
                bne.s   Offset_0x026790
